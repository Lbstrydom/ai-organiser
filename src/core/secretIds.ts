...
export const PLUGIN_SECRET_IDS = {
    ...
    BRIGHT_DATA_BROWSER: 'ai-organiser-bright-data-browser',
    KINDLE_COOKIES: 'ai-organiser-kindle-cookies',
    AMAZON_EMAIL: 'ai-organiser-amazon-email',
    AMAZON_PASSWORD: 'ai-organiser-amazon-password',
    RESEARCH_TAVILY_API_KEY: 'ai-organiser-research-tavily-key',
    BRIGHT_DATA_SERP_KEY: 'ai-organiser-bright-data-serp-key',
 ...
 */
export type EmbeddingProviderType = 'openai' | 'gemini' | 'ollama' | 'openrouter' | 'cohere' | 'voyage' | 'local-onnx';
