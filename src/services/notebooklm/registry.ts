...
export class RegistryService {
    ...
    async loadRegistry(): Promise<void> {
        try {
            ...
            console.error('Failed to load NotebookLM registry:', error);
    ...
    async saveRegistry(): Promise<void> {
        ...
        try {
            ...
            console.error('Failed to save NotebookLM registry:', error);
            throw error;
        }
    }
    ...
    async getPreviousManifest(scopeKey: string): Promise<PackManifest | null> {
        ...
        try {
            ...
            console.error('Failed to load previous manifest:', error);
            return null;
        }
    }
