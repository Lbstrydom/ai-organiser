...
export const en: Translations = {
    ...
    messages: {
        ...
        smartSummarizeNoContent: "No selection, link, or frontmatter target found to summarize",
        externalFilesDesktopOnly: "External file access is only available on desktop",
