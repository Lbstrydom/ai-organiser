...
export class ContentSizeModal extends Modal {
    ...
    onOpen(): void {
        ...
        contentEl.addClass('content-size-modal');
        ...
        contentEl.createEl('p', {
            text: description,
            cls: 'content-size-description'
        });

        // Truncate option
        const truncateSection = contentEl.createEl('div', { cls: 'content-size-option' });
        ...
        // Chunk option
        const chunkSection = contentEl.createEl('div', { cls: 'content-size-option' });
