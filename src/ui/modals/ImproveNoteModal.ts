...
export class ImproveNoteModal extends Modal {
    ...
    onOpen() {
        ...
        contentEl.empty();
        contentEl.addClass('ai-organiser-improve-note-modal');
        ...
        contentEl.createEl('p', {
            ...
            cls: 'ai-organiser-improve-note-description'
        });
        ...
        if (this.personas.length > 1) {
            ...
            personaRow.createEl('span', {
                text: this.t.modals.improveNote.writingStyle,
        ...
        const textAreaContainer = contentEl.createEl('div', { cls: 'ai-organiser-improve-note-input' });
        new Setting(textAreaContainer)
            ...
            .addTextArea(text => {
                ...
                text.inputEl.addClass('ai-organiser-improve-note-textarea');
        ...
        const detailsEl = contentEl.createEl('details', { cls: 'ai-organiser-improve-note-examples' });
        ...
        // Buttons
        const buttonContainer = contentEl.createEl('div', { cls: 'ai-organiser-improve-note-buttons' });
    ...
    private async submit() {
        ...
        try {
            ...
            logger.error('UI', 'Improve note error:', error);
