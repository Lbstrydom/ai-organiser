...
export class HighlightColorModal extends Modal {
    ...
    onOpen() {
        ...
        // Color grid
        const colorGrid = contentEl.createDiv({ cls: 'highlight-color-grid' });

        for (const color of HIGHLIGHT_COLORS) {
            const colorBtn = colorGrid.createDiv({ cls: 'highlight-color-btn' });
            ...
            const label = colorBtn.createSpan({ cls: 'highlight-color-label' });
        ...
        const clearBtn = contentEl.createDiv({ cls: 'highlight-clear-btn' });
