...
/** @deprecated Use NoteSourceType */
export type SourceType = NoteSourceType;
...
export function formatSourceReference(source: SourceReference): string {
    ...
    const typeLabels: Record<NoteSourceType, string> = {
        audio: 'Audio',
        video: 'Video',
        youtube: 'YouTube',
        web: 'Web',
 ...
 */
function detectSourceTypeFromLink(link: string): NoteSourceType {
