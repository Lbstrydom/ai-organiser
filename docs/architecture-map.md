...
- Generated: 2026-07-14T04:22:00.979Z   commit: b0a98b9e2b93   refresh_id: 7a4b6753-67f1-4648-b6ee-aacf492f80d0
- Drift score: 137 / threshold 20   status: `RED`
- Domains: 33   Symbols: 2473   Layering violations: 0
...
- [core](#core) — 36 symbols
- [embeddings](#embeddings) — 15 symbols
...
- [src](#src) — 2 symbols
- [tests](#tests) — 228 symbols
- [tests-mocks](#tests-mocks) — 28 symbols
- [tts](#tts) — 26 symbols
- [ui](#ui) — 170 symbols
...
| [`estimateNarrationCost`](../src/services/audioNarration/narrationCostEstimator.ts#L14) | function | `src/services/audioNarration/narrationCostEstimator.ts` | 14-34 | Estimates narration cost in USD and EUR based on character count, chunk count, and provider pricing. | `src/services/audioNarration/audioNarrationService.ts`, `src/ui/settings/AudioNarrationSettingsSection.ts` |
...
| [`buildCssFromColors`](../src/services/chat/brandThemeService.ts#L176) | function | `src/services/chat/brandThemeService.ts` | 176-263 | Generates a complete CSS stylesheet with brand colors, typography, and slide layout styles. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`buildIconCss`](../src/services/chat/brandThemeService.ts#L107) | function | `src/services/chat/brandThemeService.ts` | 107-131 | Generates CSS for inline SVG icon sprites with size and color variants. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`buildIconReference`](../src/services/chat/brandThemeService.ts#L134) | function | `src/services/chat/brandThemeService.ts` | 134-139 | Builds a reference string listing available icon names grouped by category. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`extractSection`](../src/services/chat/brandThemeService.ts#L321) | function | `src/services/chat/brandThemeService.ts` | 321-325 | Extracts markdown section content between two level-2 headings using regex. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`getBrandPath`](../src/services/chat/brandThemeService.ts#L312) | function | `src/services/chat/brandThemeService.ts` | 312-317 | Returns custom brand path from settings or constructs default path from plugin folder and config folder. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`getDefaultTheme`](../src/services/chat/brandThemeService.ts#L267) | function | `src/services/chat/brandThemeService.ts` | 267-273 | Returns default theme with CSS, empty prompt rules, and empty audit checklist. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`isBrandAvailable`](../src/services/chat/brandThemeService.ts#L275) | function | `src/services/chat/brandThemeService.ts` | 275-278 | Checks if a brand guidelines file exists at the configured path. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`loadBrandTheme`](../src/services/chat/brandThemeService.ts#L280) | function | `src/services/chat/brandThemeService.ts` | 280-298 | Loads and parses brand theme file from vault, with error handling and type-checking. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`parseAuditChecklist`](../src/services/chat/brandThemeService.ts#L407) | function | `src/services/chat/brandThemeService.ts` | 407-414 | Converts markdown rules into audit checklist items with generated IDs. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`parseBrandFile`](../src/services/chat/brandThemeService.ts#L327) | function | `src/services/chat/brandThemeService.ts` | 327-342 | Parses brand file sections and builds theme with CSS, prompt rules, and audit checklist. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`parseColors`](../src/services/chat/brandThemeService.ts#L345) | function | `src/services/chat/brandThemeService.ts` | 345-388 | Parses color table from markdown and maps role keywords to color slots, using first match per slot. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`parseFont`](../src/services/chat/brandThemeService.ts#L390) | function | `src/services/chat/brandThemeService.ts` | 390-395 | Extracts font family from markdown list and wraps with fallbacks. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`parseRules`](../src/services/chat/brandThemeService.ts#L397) | function | `src/services/chat/brandThemeService.ts` | 397-405 | Extracts bullet-point rules from markdown section, stripping dashes and filtering blanks. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
| [`resolveTheme`](../src/services/chat/brandThemeService.ts#L300) | function | `src/services/chat/brandThemeService.ts` | 300-308 | Returns brand theme if enabled and available, otherwise returns default theme. | `src/services/export/brand/brandRenderContext.ts`, `src/services/export/brand/exampleBrandTheme.ts`, `src/services/prompts/presentationChatPrompts.ts`, +3 more |
...
| [`buildDeckContextSummary`](../src/services/chat/presentationDomDecorator.ts#L260) | function | `src/services/chat/presentationDomDecorator.ts` | 260-280 | Summarizes a presentation deck by counting slides, extracting the title, and listing section headings. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`buildDesignSummary`](../src/services/chat/presentationDomDecorator.ts#L290) | function | `src/services/chat/presentationDomDecorator.ts` | 290-330 | Catalogs the deck's layout classes, component usage (grids, callouts, tables, figures, images), and provides design guidance. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`cssAttrEscape`](../src/services/chat/presentationDomDecorator.ts#L249) | function | `src/services/chat/presentationDomDecorator.ts` | 249-251 | Escapes double-quotes and backslashes in CSS attribute values for safe selector matching. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`decorateByKind`](../src/services/chat/presentationDomDecorator.ts#L116) | function | `src/services/chat/presentationDomDecorator.ts` | 116-131 | Finds all untagged elements matching a selector in a slide and assigns them sequential `data-element` identifiers. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`decorateSlideElements`](../src/services/chat/presentationDomDecorator.ts#L68) | function | `src/services/chat/presentationDomDecorator.ts` | 68-114 | Tags all child elements within a slide with `data-element` paths, handling lists, headings, and generic component selectors with per-kind counters. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`estimateScopedPromptChars`](../src/services/chat/presentationDomDecorator.ts#L351) | function | `src/services/chat/presentationDomDecorator.ts` | 351-369 | Estimates the character count of a scoped-edit prompt by multiplying canonical HTML by 2, adding extras, and overhead. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`extractScopedFragment`](../src/services/chat/presentationDomDecorator.ts#L207) | function | `src/services/chat/presentationDomDecorator.ts` | 207-246 | Extracts a scoped fragment (slide, range, or element) from canonical HTML using fail-closed semantics, stripping instrumentation before returning. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`projectForEditor`](../src/services/chat/presentationDomDecorator.ts#L50) | function | `src/services/chat/presentationDomDecorator.ts` | 50-65 | Parses canonical HTML, assigns `data-element` identifiers to the deck and slides, decorates slide elements, and returns the serialized result. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`serializePreservingWrapper`](../src/services/chat/presentationDomDecorator.ts#L172) | function | `src/services/chat/presentationDomDecorator.ts` | 172-184 | Serializes a parsed DOM document, preserving the original doctype and HTML structure for full-document inputs. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
| [`stripEditorAnnotations`](../src/services/chat/presentationDomDecorator.ts#L147) | function | `src/services/chat/presentationDomDecorator.ts` | 147-155 | Parses HTML, removes all `data-element` attributes, and returns the cleaned serialized result. | `src/services/chat/presentationDiff.ts`, `src/services/chat/presentationHtmlService.ts`, `src/ui/chat/PresentationModeHandler.ts`, +1 more |
...
| [`classifyReliability`](../src/services/chat/presentationTypes.ts#L116) | function | `src/services/chat/presentationTypes.ts` | 116-134 | Classifies HTML presentation reliability as ok, warning, structurally-damaged, or unreliable based on rejection counts and structural validation. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationDeckStore.ts` |
| [`computeQualityScore`](../src/services/chat/presentationTypes.ts#L205) | function | `src/services/chat/presentationTypes.ts` | 205-221 | Computes a quality score from structure findings and audit violations, capped between 0 and 100. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationDeckStore.ts` |
| [`extractSlideInfo`](../src/services/chat/presentationTypes.ts#L146) | function | `src/services/chat/presentationTypes.ts` | 146-168 | Extracts slide metadata (index, heading, text length, notes presence, type) from a DOM document using a canonical slide selector. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationDeckStore.ts` |
| [`migratePresentationSession`](../src/services/chat/presentationTypes.ts#L225) | function | `src/services/chat/presentationTypes.ts` | 225-267 | Migrates a persisted presentation session from storage, validating all required fields and constraining message roles and version counts. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationDeckStore.ts` |
| [`runStructureChecks`](../src/services/chat/presentationTypes.ts#L170) | function | `src/services/chat/presentationTypes.ts` | 170-203 | Runs quality checks on slide structure (min/max slides, content length, headings, notes) and returns findings with severity levels. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationDeckStore.ts` |
...
> The `core` domain provides result type wrappers for error handling and utility functions for resolving and normalizing plugin/output folder paths with timezone settings.
...
subgraph dom_core ["core"]
  ...
  sym_src_core_settings_ts_getTranscriptOutput["getTranscriptOutputFullPath"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_getTranscriptOutput
  ...
  sym_src_core_settings_ts_migrateAzureSetting["migrateAzureSettings"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migrateAzureSetting
  sym_src_core_settings_ts_migrateBrandSetting["migrateBrandSettings"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migrateBrandSetting
  ...
  sym_src_core_settings_ts_migrateFeatureFlags["migrateFeatureFlags"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migrateFeatureFlags
  sym_src_core_settings_ts_migrateLocalOnnxCon["migrateLocalOnnxConsent"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migrateLocalOnnxCon
  ...
  sym_src_core_settings_ts_migratePickerTaxono["migratePickerTaxonomy"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migratePickerTaxono
  sym_src_core_settings_ts_migrateVisualSearch["migrateVisualSearchSettings"]:::symbol
  file_src_core_settings_ts --> sym_src_core_settings_ts_migrateVisualSearch
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`err`](../src/core/result.ts#L6) | function | `src/core/result.ts` | 6-6 | Returns error result wrapper with provided error. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/audioNarration/narrationTypes.ts`, +46 more |
| [`ok`](../src/core/result.ts#L5) | function | `src/core/result.ts` | 5-5 | Returns success result wrapper with provided value. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/audioNarration/narrationTypes.ts`, +46 more |
| [`collapseDuplicatePrefix`](../src/core/settings.ts#L927) | function | `src/core/settings.ts` | 927-937 | Removes duplicate plugin folder prefixes from a path by iteratively collapsing them. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getAudioNarrationFullPath`](../src/core/settings.ts#L1027) | function | `src/core/settings.ts` | 1027-1029 | Returns the full path to the audio narration output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getCanvasOutputFullPath`](../src/core/settings.ts#L1035) | function | `src/core/settings.ts` | 1035-1037 | Returns the full path to the canvas output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getChatExportFullPath`](../src/core/settings.ts#L1031) | function | `src/core/settings.ts` | 1031-1033 | Returns the full path to the chat export folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getChatRootFullPath`](../src/core/settings.ts#L1097) | function | `src/core/settings.ts` | 1097-1101 | Returns the full path to the AI chat root folder using the effective output root. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getConfigFolderFullPath`](../src/core/settings.ts#L994) | function | `src/core/settings.ts` | 994-996 | Returns the full path to the config folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getDefaultTimezone`](../src/core/settings.ts#L531) | function | `src/core/settings.ts` | 531-537 | Retrieves the system's current timezone or defaults to UTC. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getDictionariesFolderFullPath`](../src/core/settings.ts#L1002) | function | `src/core/settings.ts` | 1002-1004 | Returns the full path to the dictionaries folder inside config. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getEffectiveOutputRoot`](../src/core/settings.ts#L956) | function | `src/core/settings.ts` | 956-962 | Determines the effective output root folder, falling back to the plugin folder if unset. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getExportOutputFullPath`](../src/core/settings.ts#L1019) | function | `src/core/settings.ts` | 1019-1021 | Returns the full path to the exports output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getFlashcardFullPath`](../src/core/settings.ts#L1023) | function | `src/core/settings.ts` | 1023-1025 | Returns the full path to the flashcards folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getKindleOutputFullPath`](../src/core/settings.ts#L1043) | function | `src/core/settings.ts` | 1043-1045 | Returns the full path to the Kindle output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getMinutesOutputFullPath`](../src/core/settings.ts#L1006) | function | `src/core/settings.ts` | 1006-1008 | Returns the full path to the meetings/minutes output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getNewsletterOutputFullPath`](../src/core/settings.ts#L1047) | function | `src/core/settings.ts` | 1047-1049 | Returns the full path to the newsletter inbox output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getNotebookLMExportFullPath`](../src/core/settings.ts#L998) | function | `src/core/settings.ts` | 998-1000 | Returns the full path to the NotebookLM export folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getOutputSubfolderPath`](../src/core/settings.ts#L990) | function | `src/core/settings.ts` | 990-992 | Constructs an output subfolder path using the effective output root. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getPluginManagedFolders`](../src/core/settings.ts#L1068) | function | `src/core/settings.ts` | 1068-1094 | Collects all plugin-managed folders for exclusion, differing based on whether output root matches plugin folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getPluginSubfolderPath`](../src/core/settings.ts#L914) | function | `src/core/settings.ts` | 914-916 | Constructs a subfolder path by joining the plugin folder with a subfolder name. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getResearchOutputFullPath`](../src/core/settings.ts#L1059) | function | `src/core/settings.ts` | 1059-1061 | Returns the full path to the research output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getSketchOutputFullPath`](../src/core/settings.ts#L1055) | function | `src/core/settings.ts` | 1055-1057 | Returns the full path to the sketches output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getTranscriptFullPath`](../src/core/settings.ts#L1051) | function | `src/core/settings.ts` | 1051-1053 | Returns the full path to the transcripts folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getTranscriptOutputFullPath`](../src/core/settings.ts#L1015) | function | `src/core/settings.ts` | 1015-1017 | Returns the full path to the transcripts output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`getWebReaderOutputFullPath`](../src/core/settings.ts#L1039) | function | `src/core/settings.ts` | 1039-1041 | Returns the full path to the web reader output folder. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateAzureSettings`](../src/core/settings.ts#L1419) | function | `src/core/settings.ts` | 1419-1627 | <no body> | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateBrandSettings`](../src/core/settings.ts#L1386) | function | `src/core/settings.ts` | 1386-1402 | Migrates brand guidelines path to the new brandFolderPath by extracting the parent directory. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateDeprecatedGeminiIds`](../src/core/settings.ts#L1651) | function | `src/core/settings.ts` | 1651-1666 | Remaps deprecated Gemini model IDs to their current equivalents. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateFeatureFlags`](../src/core/settings.ts#L1282) | function | `src/core/settings.ts` | 1282-1305 | Migrates legacy feature flag settings into the new unified featureFlags structure with defaults. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateLocalOnnxConsent`](../src/core/settings.ts#L1263) | function | `src/core/settings.ts` | 1263-1267 | Enables local ONNX embeddings when migrating from the deprecated local-onnx embedding provider. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateOldSettings`](../src/core/settings.ts#L1108) | function | `src/core/settings.ts` | 1108-1249 | <no body> | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migratePickerTaxonomy`](../src/core/settings.ts#L1317) | function | `src/core/settings.ts` | 1317-1336 | Migrates command picker settings by renaming keys, remapping category IDs, and deduplicating. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`migrateVisualSearchSettings`](../src/core/settings.ts#L1361) | function | `src/core/settings.ts` | 1361-1384 | Validates and constrains visual search settings (embedding dimension, pages per attachment, RPM, Azure image probe). | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`normalizeFolderSegment`](../src/core/settings.ts#L918) | function | `src/core/settings.ts` | 918-925 | Cleans and normalizes a folder path segment by trimming, converting backslashes, and removing leading/trailing slashes. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`resolveOutputPath`](../src/core/settings.ts#L968) | function | `src/core/settings.ts` | 968-985 | Resolves a folder value to a full output path, handling legacy prefixes and migrating from plugin folder when needed. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |
| [`resolvePluginPath`](../src/core/settings.ts#L939) | function | `src/core/settings.ts` | 939-950 | Resolves a folder value to a full plugin path, handling legacy full paths and normalizing the result. | `src/commands/canvasCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +29 more |

---

## embeddings

> The `embeddings` domain provides embedding service abstractions and factories for multiple providers (Cohere, Gemini, local ONNX), handling model registration, availability classification, and instantiation based on provider configuration and API key requirements.
...
subgraph dom_embeddings ["embeddings"]
  ...
  sym_src_services_embeddings_embeddingService["classifyEmbeddingAvailability"]:::symbol
  ...
  file_src_services_embeddings_embeddingService --> sym_src_services_embeddings_embeddingService
  sym_src_services_embeddings_embeddingService["resolveLocalOnnxEmbeddingService"]:::symbol
  file_src_services_embeddings_embeddingService --> sym_src_services_embeddings_embeddingService
...
| [`classifyEmbeddingAvailability`](../src/services/embeddings/embeddingServiceFactory.ts#L53) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 53-73 | Classifies embedding service availability based on provider, API key, Azure mode, and consent status. | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`createEmbeddingService`](../src/services/embeddings/embeddingServiceFactory.ts#L87) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 87-149 | <no body> | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`createEmbeddingServiceFromSettings`](../src/services/embeddings/embeddingServiceFactory.ts#L169) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 169-260 | <no body> | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`getAvailableEmbeddingModels`](../src/services/embeddings/embeddingServiceFactory.ts#L272) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 272-274 | Returns the list of available embedding models for a given provider. | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`getDefaultEmbeddingModel`](../src/services/embeddings/embeddingServiceFactory.ts#L265) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 265-267 | Returns the default embedding model for a given provider. | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`requiresApiKey`](../src/services/embeddings/embeddingServiceFactory.ts#L279) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 279-281 | Checks whether a provider requires an API key. | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
| [`resolveLocalOnnxEmbeddingService`](../src/services/embeddings/embeddingServiceFactory.ts#L32) | function | `src/services/embeddings/embeddingServiceFactory.ts` | 32-41 | Returns a LocalOnnxEmbeddingService if consent is enabled, otherwise returns an error. | `src/services/embeddings/index.ts`, `src/ui/settings/SemanticSearchSettingsSection.ts` |
...
| [`LocalOnnxEmbeddingService`](../src/services/embeddings/localOnnxEmbeddingService.ts#L27) | class | `src/services/embeddings/localOnnxEmbeddingService.ts` | 27-108 | <no body> | `src/services/embeddings/embeddingServiceFactory.ts`, `src/ui/chat/FreeChatModeHandler.ts` |
...
| [`__resetDynamicModelCache`](../src/services/adapters/dynamicModelService.ts#L46) | function | `src/services/adapters/dynamicModelService.ts` | 46-48 | Clears the live model cache for all providers. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`fetchAnthropic`](../src/services/adapters/dynamicModelService.ts#L119) | function | `src/services/adapters/dynamicModelService.ts` | 119-140 | Fetches available models from Anthropic's /models endpoint. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`fetchGemini`](../src/services/adapters/dynamicModelService.ts#L161) | function | `src/services/adapters/dynamicModelService.ts` | 161-187 | Fetches available Gemini models from Google's API, filtering by generation capability. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`fetchLiveModels`](../src/services/adapters/dynamicModelService.ts#L59) | function | `src/services/adapters/dynamicModelService.ts` | 59-68 | Fetches live models from a provider's API and updates the cache. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`fetchOpenAICompat`](../src/services/adapters/dynamicModelService.ts#L142) | function | `src/services/adapters/dynamicModelService.ts` | 142-159 | Creates a generic OpenAI-compatible models fetcher for a given URL. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`getCachedModels`](../src/services/adapters/dynamicModelService.ts#L51) | function | `src/services/adapters/dynamicModelService.ts` | 51-53 | Retrieves cached models for a provider if they exist and are fresh. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`getLiveModels`](../src/services/adapters/dynamicModelService.ts#L78) | function | `src/services/adapters/dynamicModelService.ts` | 78-101 | Gets live models for a provider with caching and fallback to static models. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
| [`providerSupportsLiveFetch`](../src/services/adapters/dynamicModelService.ts#L191) | function | `src/services/adapters/dynamicModelService.ts` | 191-193 | Checks whether a provider has a registered live model fetcher. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +3 more |
...
| [`claudeHas1MContext`](../src/services/adapters/modelCapabilities.ts#L69) | function | `src/services/adapters/modelCapabilities.ts` | 69-71 | Checks if a Claude model supports 1M context window (same as adaptive thinking support). | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`claudeSupportsAdaptiveThinking`](../src/services/adapters/modelCapabilities.ts#L52) | function | `src/services/adapters/modelCapabilities.ts` | 52-57 | Determines whether a Claude model supports adaptive thinking based on tier and version. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`claudeSupportsDynamicWebSearch`](../src/services/adapters/modelCapabilities.ts#L78) | function | `src/services/adapters/modelCapabilities.ts` | 78-80 | Checks if a Claude model supports dynamic web search (same as adaptive thinking support). | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`geminiSupportsThinking`](../src/services/adapters/modelCapabilities.ts#L178) | function | `src/services/adapters/modelCapabilities.ts` | 178-184 | Determines whether a Gemini model supports thinking mode based on tier and version. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`openaiIsReasoningModel`](../src/services/adapters/modelCapabilities.ts#L129) | function | `src/services/adapters/modelCapabilities.ts` | 129-132 | Determines whether an OpenAI model is a reasoning model (o-series). | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`parseClaudeModel`](../src/services/adapters/modelCapabilities.ts#L30) | function | `src/services/adapters/modelCapabilities.ts` | 30-39 | Parses a Claude model ID to extract tier (opus/sonnet/haiku) and version numbers. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`parseGeminiModel`](../src/services/adapters/modelCapabilities.ts#L162) | function | `src/services/adapters/modelCapabilities.ts` | 162-175 | Parses a Gemini model ID to extract version, tier, and feature flags (preview/tts/lite). | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
...
| [`pickNewestClaude`](../src/services/adapters/modelCapabilities.ts#L203) | function | `src/services/adapters/modelCapabilities.ts` | 203-213 | Selects the newest Claude model of a specified tier from available IDs. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`pickNewestGemini`](../src/services/adapters/modelCapabilities.ts#L219) | function | `src/services/adapters/modelCapabilities.ts` | 219-232 | Selects the newest Gemini model of a specified tier, preferring GA over preview. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`pickNewestOpenAI`](../src/services/adapters/modelCapabilities.ts#L235) | function | `src/services/adapters/modelCapabilities.ts` | 235-253 | Selects the newest OpenAI model of a specified tier/variant from available IDs. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`resolveLatestModel`](../src/services/adapters/modelCapabilities.ts#L267) | function | `src/services/adapters/modelCapabilities.ts` | 267-303 | Resolves "latest-{tier}" sentinel model IDs to actual model IDs using available pools. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`resolveSpecialistModel`](../src/services/adapters/modelCapabilities.ts#L318) | function | `src/services/adapters/modelCapabilities.ts` | 318-328 | Resolves specialist "latest-" model sentinels using live or static model pools. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`versionAtLeast`](../src/services/adapters/modelCapabilities.ts#L42) | function | `src/services/adapters/modelCapabilities.ts` | 42-45 | Checks if a parsed Claude version is at least a specified major.minor version. | `src/core/modelCatalog.ts`, `src/services/adapters/azureClaudeAdapter.ts`, `src/services/adapters/claudeAdapter.ts`, +8 more |
| [`getFirstModel`](../src/services/adapters/modelRegistry.ts#L163) | function | `src/services/adapters/modelRegistry.ts` | 163-167 | Gets the first available model ID for a provider. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +1 more |
| [`getProviderModels`](../src/services/adapters/modelRegistry.ts#L149) | function | `src/services/adapters/modelRegistry.ts` | 149-151 | Retrieves the model registry for a specific provider. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +1 more |
| [`hasModelList`](../src/services/adapters/modelRegistry.ts#L156) | function | `src/services/adapters/modelRegistry.ts` | 156-158 | Checks whether a provider has models configured in the registry. | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +1 more |
| [`isValidModel`](../src/services/adapters/modelRegistry.ts#L172) | function | `src/services/adapters/modelRegistry.ts` | 172-176 | Validates whether a model ID exists for a provider (allows unknown providers). | `src/services/cloudService.ts`, `src/services/research/adapters/claudeWebSearchAdapter.ts`, `src/services/specialistModelResolver.ts`, +1 more |
...
| [`buildProviderOptions`](../src/services/adapters/providerRegistry.ts#L68) | function | `src/services/adapters/providerRegistry.ts` | 68-85 | Builds a mapping of provider names to their localized display labels. | `src/services/adapters/openaiAdapter.ts`, `src/services/apiKeyHelpers.ts`, `src/services/audioTranscriptionService.ts`, +9 more |
...
| [`dismissModal`](../scripts/persona-harness/driver.mjs#L302) | function | `scripts/persona-harness/driver.mjs` | 302-305 | Dismisses a modal or menu by pressing Escape. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`dumpCommandPickerStructure`](../scripts/persona-harness/driver.mjs#L315) | function | `scripts/persona-harness/driver.mjs` | 315-328 | Extracts all AI Organiser commands from the global app object and returns their count and metadata. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`ensureVaultOpen`](../scripts/persona-harness/driver.mjs#L128) | function | `scripts/persona-harness/driver.mjs` | 128-177 | Opens a vault from the starter page by clicking the matching recent vault entry. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`findMainPage`](../scripts/persona-harness/driver.mjs#L106) | function | `scripts/persona-harness/driver.mjs` | 106-117 | Finds and returns the main Obsidian app page from browser contexts. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`isObsidianRunning`](../scripts/persona-harness/driver.mjs#L24) | function | `scripts/persona-harness/driver.mjs` | 24-34 | Checks whether Obsidian process is currently running on Windows. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`launchOrAttach`](../scripts/persona-harness/driver.mjs#L63) | function | `scripts/persona-harness/driver.mjs` | 63-99 | Launches Obsidian with remote debugging port or attaches to existing instance via CDP. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`openPaletteAndType`](../scripts/persona-harness/driver.mjs#L295) | function | `scripts/persona-harness/driver.mjs` | 295-299 | Opens the command palette with Ctrl+P and optionally types a search query. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`openPluginCommandPicker`](../scripts/persona-harness/driver.mjs#L208) | function | `scripts/persona-harness/driver.mjs` | 208-214 | Triggers plugin command picker modal by running a ready command. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`openPluginCommandPickerViaRibbon`](../scripts/persona-harness/driver.mjs#L224) | function | `scripts/persona-harness/driver.mjs` | 224-228 | Opens plugin command picker by clicking ribbon button with matching tooltip. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`openVaultFile`](../scripts/persona-harness/driver.mjs#L271) | function | `scripts/persona-harness/driver.mjs` | 271-282 | Opens a file from the vault using the Obsidian API by path and waits for it to load. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`readVisibleMenuItems`](../scripts/persona-harness/driver.mjs#L285) | function | `scripts/persona-harness/driver.mjs` | 285-292 | Reads all visible menu items and extracts their text and submenu status. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`rightClickEditor`](../scripts/persona-harness/driver.mjs#L244) | function | `scripts/persona-harness/driver.mjs` | 244-248 | Right-clicks the editor content area and waits for a context menu to appear. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
...
| [`rightClickFileInTree`](../scripts/persona-harness/driver.mjs#L234) | function | `scripts/persona-harness/driver.mjs` | 234-238 | Right-clicks a file in the navigation tree by name and waits for a context menu to appear. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`runCommand`](../scripts/persona-harness/driver.mjs#L198) | function | `scripts/persona-harness/driver.mjs` | 198-205 | Executes a registered command by ID in the Obsidian app. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`stampedName`](../scripts/persona-harness/driver.mjs#L331) | function | `scripts/persona-harness/driver.mjs` | 331-333 | Generates a timestamped filename for a screenshot. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`waitForPluginReady`](../scripts/persona-harness/driver.mjs#L183) | function | `scripts/persona-harness/driver.mjs` | 183-192 | Waits for a plugin command to be registered in the app command registry. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
| [`waitForPort`](../scripts/persona-harness/driver.mjs#L37) | function | `scripts/persona-harness/driver.mjs` | 37-54 | Polls a network port until connection succeeds or timeout is reached. | `scripts/persona-harness/azure-feature-sweep.mjs`, `scripts/persona-harness/azure-ui-flows.mjs`, `scripts/persona-harness/command-picker-collapsible.mjs`, +46 more |
...
| [`buildAgendaExtractionPrompt`](../src/services/prompts/minutesPrompts.ts#L1047) | function | `src/services/prompts/minutesPrompts.ts` | 1047-1078 | Generates a prompt to extract meeting metadata (title, date, time, location, participants, agenda) from an unstructured document. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildChunkExtractionPrompt`](../src/services/prompts/minutesPrompts.ts#L783) | function | `src/services/prompts/minutesPrompts.ts` | 783-840 | Generates a prompt to extract actions, decisions, risks, and notable points from a single transcript chunk with meeting context. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildContextExtractionPrompt`](../src/services/prompts/minutesPrompts.ts#L1157) | function | `src/services/prompts/minutesPrompts.ts` | 1157-1196 | Generates a prompt to extract meeting-relevant facts (people, dates, figures, acronyms, decisions) from context documents for verification. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildDetailedStyleCore`](../src/services/prompts/minutesPrompts.ts#L244) | function | `src/services/prompts/minutesPrompts.ts` | 244-273 | Generates a system prompt for detailed narrative minutes with formal third-person tone, governance verbs, decisions and actions tables, and separated financial/operational content. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildGuidedStyleCore`](../src/services/prompts/minutesPrompts.ts#L275) | function | `src/services/prompts/minutesPrompts.ts` | 275-298 | Generates a system prompt that applies a reference document's voice, formatting, and structural patterns to the current meeting's minutes. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildIntermediateMergePrompt`](../src/services/prompts/minutesPrompts.ts#L847) | function | `src/services/prompts/minutesPrompts.ts` | 847-879 | Generates a prompt to deduplicate and merge extracted items from multiple consecutive transcript chunks. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildMinutesUserPrompt`](../src/services/prompts/minutesPrompts.ts#L731) | function | `src/services/prompts/minutesPrompts.ts` | 731-771 | Assembles meeting metadata, participants, transcript, and optional terminology/context documents into a JSON payload for processing. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildSharedPromptSuffix`](../src/services/prompts/minutesPrompts.ts#L300) | function | `src/services/prompts/minutesPrompts.ts` | 300-600 | <no body> | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildSmartBrevityStyleCore`](../src/services/prompts/minutesPrompts.ts#L192) | function | `src/services/prompts/minutesPrompts.ts` | 192-214 | Generates a system prompt for Smart Brevity-style minutes with a structure of big thing, why it matters, decisions, actions, and deeper discussion. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildSpeakerLabellingPrompt`](../src/services/prompts/minutesPrompts.ts#L1229) | function | `src/services/prompts/minutesPrompts.ts` | 1229-1285 | Generates a prompt to add speaker labels to an unlabelled transcript using a participant list and conversational cues. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildStandardStyleCore`](../src/services/prompts/minutesPrompts.ts#L216) | function | `src/services/prompts/minutesPrompts.ts` | 216-242 | Generates a system prompt for standard-style minutes with brief per-agenda sections, separated financial and operational topics, and emphasis on brevity. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildStyleConsolidationPrompt`](../src/services/prompts/minutesPrompts.ts#L606) | function | `src/services/prompts/minutesPrompts.ts` | 606-729 | <no body> | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`buildStyleExtractionPrompt`](../src/services/prompts/minutesPrompts.ts#L1119) | function | `src/services/prompts/minutesPrompts.ts` | 1119-1149 | Generates a prompt to extract a reusable style guide (heading structure, tone, formatting) from a reference minutes document without reproducing content. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`extractJsonByBraceMatching`](../src/services/prompts/minutesPrompts.ts#L932) | function | `src/services/prompts/minutesPrompts.ts` | 932-1003 | Extracts a balanced JSON object from text by matching braces, recovering from truncation by closing at the last nested object boundary. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`getStyleCore`](../src/services/prompts/minutesPrompts.ts#L178) | function | `src/services/prompts/minutesPrompts.ts` | 178-190 | Routes to the appropriate style-specific prompt builder based on the selected minutes style (smart-brevity, detailed, guided, or standard). | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`getStyleSystemPrompt`](../src/services/prompts/minutesPrompts.ts#L172) | function | `src/services/prompts/minutesPrompts.ts` | 172-176 | Returns a system prompt for meeting minutes by combining style-specific core rules with a shared suffix. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`parseAgendaExtractionResponse`](../src/services/prompts/minutesPrompts.ts#L1084) | function | `src/services/prompts/minutesPrompts.ts` | 1084-1105 | Parses an agenda extraction response, validating and returning structured meeting metadata with empty defaults for missing fields. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`parseJsonWithRepair`](../src/services/prompts/minutesPrompts.ts#L1005) | function | `src/services/prompts/minutesPrompts.ts` | 1005-1028 | Attempts to parse JSON with automatic repairs for common LLM errors (newlines in strings, trailing commas, unquoted keys). | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`parseMinutesResponse`](../src/services/prompts/minutesPrompts.ts#L881) | function | `src/services/prompts/minutesPrompts.ts` | 881-930 | Parses an LLM response containing JSON and optional dual markdown sections, extracting both structured data and internal/external minutes. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
| [`tryParseAgendaJson`](../src/services/prompts/minutesPrompts.ts#L1199) | function | `src/services/prompts/minutesPrompts.ts` | 1199-1216 | Attempts to parse JSON from a response by trying direct parse, code fence extraction, and object pattern matching. | `src/services/minutes/multiSegmentMinutes.ts`, `src/services/minutesService.ts`, `src/services/speakerLabellingService.ts`, +1 more |
...
| [`buildBrandAuditPrompt`](../src/services/prompts/presentationChatPrompts.ts#L187) | function | `src/services/prompts/presentationChatPrompts.ts` | 187-220 | Generates a prompt to audit presentation HTML against brand rules and return JSON with violations and fixes. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildCreationPromptWithStyle`](../src/services/prompts/presentationChatPrompts.ts#L468) | function | `src/services/prompts/presentationChatPrompts.ts` | 468-499 | Generates a prompt to create a presentation from user query, sources, audience type, and target slide length. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildGenerationPrompt`](../src/services/prompts/presentationChatPrompts.ts#L142) | function | `src/services/prompts/presentationChatPrompts.ts` | 142-162 | Generates a prompt with conversation history, note content, and user request to guide presentation generation. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildPresentationSystemPrompt`](../src/services/prompts/presentationChatPrompts.ts#L85) | function | `src/services/prompts/presentationChatPrompts.ts` | 85-140 | Generates a comprehensive system prompt for a presentation designer with design principles, brand rules, icon reference, and slide structure guidance. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildRefinementPrompt`](../src/services/prompts/presentationChatPrompts.ts#L166) | function | `src/services/prompts/presentationChatPrompts.ts` | 166-183 | Generates a prompt to modify a presentation HTML according to user feedback while returning the complete updated deck. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildScopedContentEditPrompt`](../src/services/prompts/presentationChatPrompts.ts#L366) | function | `src/services/prompts/presentationChatPrompts.ts` | 366-413 | Generates a prompt to make a content-only edit to a scoped slide region while preserving all other slides byte-for-byte. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`buildScopedDesignEditPrompt`](../src/services/prompts/presentationChatPrompts.ts#L423) | function | `src/services/prompts/presentationChatPrompts.ts` | 423-460 | Generates a prompt to make a design-only edit (layout, hierarchy, visual emphasis) to a scoped region without changing text or data. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`countSlides`](../src/services/prompts/presentationChatPrompts.ts#L310) | function | `src/services/prompts/presentationChatPrompts.ts` | 310-313 | Counts the number of slides in deck HTML by counting elements with class="slide". | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`defangDelimiter`](../src/services/prompts/presentationChatPrompts.ts#L61) | function | `src/services/prompts/presentationChatPrompts.ts` | 61-63 | Returns a defanged HTML tag by inserting a space after the opening angle bracket. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`describeScope`](../src/services/prompts/presentationChatPrompts.ts#L346) | function | `src/services/prompts/presentationChatPrompts.ts` | 346-357 | Returns a human-readable description of a scope (range of slides, single slide, or element) for prompt context. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`escapeAttrValue`](../src/services/prompts/presentationChatPrompts.ts#L501) | function | `src/services/prompts/presentationChatPrompts.ts` | 501-503 | Escapes XML/HTML special characters in attribute values to prevent injection. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`extractDeckTitle`](../src/services/prompts/presentationChatPrompts.ts#L297) | function | `src/services/prompts/presentationChatPrompts.ts` | 297-305 | Extracts a presentation title from HTML by checking data-title attribute, h1 tag, or defaulting to 'Presentation'. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`extractHtmlFromResponse`](../src/services/prompts/presentationChatPrompts.ts#L228) | function | `src/services/prompts/presentationChatPrompts.ts` | 228-260 | Extracts HTML deck content from an LLM response by searching for markers, code fences, specific selectors, or raw HTML tags. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`mapLanguageToHtmlLang`](../src/services/prompts/presentationChatPrompts.ts#L282) | function | `src/services/prompts/presentationChatPrompts.ts` | 282-292 | Maps language names to ISO 639-1 language codes for HTML lang attributes, defaulting to 'en'. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
...
| [`sanitizeTextForPrompt`](../src/services/prompts/presentationChatPrompts.ts#L79) | function | `src/services/prompts/presentationChatPrompts.ts` | 79-81 | Defangs text prompt delimiters to prevent injection by inserting spaces after opening angle brackets. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
| [`wrapInDocument`](../src/services/prompts/presentationChatPrompts.ts#L266) | function | `src/services/prompts/presentationChatPrompts.ts` | 266-280 | Wraps deck HTML in a complete DOCTYPE document with specified CSS theme and language attribute. | `src/services/chat/presentationHtmlService.ts`, `src/services/chat/streamingHtmlAssembler.ts`, `src/ui/chat/PresentationModeHandler.ts`, +2 more |
...
| [`buildBasicPrompt`](../src/services/prompts/summaryPrompts.ts#L121) | function | `src/services/prompts/summaryPrompts.ts` | 121-148 | Generates a basic summary prompt covering main thesis, arguments, and conclusions without persona framing. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`buildChunkCombinePrompt`](../src/services/prompts/summaryPrompts.ts#L150) | function | `src/services/prompts/summaryPrompts.ts` | 150-206 | Generates a prompt to combine multiple section summaries into one coherent output, with persona or fallback basic format. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`buildChunkContextBlock`](../src/services/prompts/summaryPrompts.ts#L30) | function | `src/services/prompts/summaryPrompts.ts` | 30-39 | Returns optional context block noting whether content is part of a multi-part document chunk. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`buildPersonaPrompt`](../src/services/prompts/summaryPrompts.ts#L93) | function | `src/services/prompts/summaryPrompts.ts` | 93-119 | Generates a persona-specific summary prompt with length instructions, language settings, link handling, and optional study companion. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`buildSummaryPrompt`](../src/services/prompts/summaryPrompts.ts#L83) | function | `src/services/prompts/summaryPrompts.ts` | 83-91 | Routes to persona-based or basic summary prompt based on available options. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`insertContentIntoPrompt`](../src/services/prompts/summaryPrompts.ts#L208) | function | `src/services/prompts/summaryPrompts.ts` | 208-210 | Replaces a content placeholder in a summary prompt template. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
| [`insertSectionsIntoPrompt`](../src/services/prompts/summaryPrompts.ts#L212) | function | `src/services/prompts/summaryPrompts.ts` | 212-217 | Formats multiple section summaries and inserts them into a prompt template. | `src/commands/summarizeCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, `src/utils/responseParser.ts` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`checkMainProviderConfigured`](../src/services/apiKeyHelpers.ts#L273) | function | `src/services/apiKeyHelpers.ts` | 273-298 | Validates that the main LLM provider is properly configured with either a local endpoint or cloud API key. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getAudioNarrationProviderConfig`](../src/services/apiKeyHelpers.ts#L128) | function | `src/services/apiKeyHelpers.ts` | 128-134 | Gets the audio narration provider configuration. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getAudioTranscriptionApiKey`](../src/services/apiKeyHelpers.ts#L179) | function | `src/services/apiKeyHelpers.ts` | 179-215 | Resolves audio transcription API key, trying selected provider first then falling back to alternative. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getAuditProviderConfig`](../src/services/apiKeyHelpers.ts#L107) | function | `src/services/apiKeyHelpers.ts` | 107-116 | Gets the audit provider configuration when LLM audit is enabled. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getClaudeWebSearchKey`](../src/services/apiKeyHelpers.ts#L249) | function | `src/services/apiKeyHelpers.ts` | 249-263 | Returns the Claude web search API key from secret storage, falling back to main provider key if cloud service is Claude. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getFlashcardProviderConfig`](../src/services/apiKeyHelpers.ts#L221) | function | `src/services/apiKeyHelpers.ts` | 221-229 | Resolves flashcard provider configuration by delegating to a specialist provider resolver. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getQuickPeekProviderConfig`](../src/services/apiKeyHelpers.ts#L235) | function | `src/services/apiKeyHelpers.ts` | 235-243 | Resolves quick peek provider configuration by delegating to a specialist provider resolver. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`getYouTubeGeminiApiKey`](../src/services/apiKeyHelpers.ts#L150) | function | `src/services/apiKeyHelpers.ts` | 150-173 | Resolves a Gemini API key for YouTube integration with multi-level fallbacks. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`resolvePlainTextKey`](../src/services/apiKeyHelpers.ts#L39) | function | `src/services/apiKeyHelpers.ts` | 39-54 | Resolves a plain-text API key for a provider from settings or provider-specific storage. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
| [`resolveSpecialistProvider`](../src/services/apiKeyHelpers.ts#L60) | function | `src/services/apiKeyHelpers.ts` | 60-101 | Resolves specialist provider configuration (api key, model, endpoint) for dedicated features. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +18 more |
...
| [`AudioRecordingService`](../src/services/audioRecordingService.ts#L76) | class | `src/services/audioRecordingService.ts` | 76-259 | Service class that manages audio recording from microphone with size tracking and format negotiation. | `src/commands/summarizeCommands.ts`, `src/ui/modals/AudioRecorderModal.ts`, `src/ui/modals/MinutesCreationModal.ts`, +2 more |
| [`getMaxRecordingMinutes`](../src/services/audioRecordingService.ts#L71) | function | `src/services/audioRecordingService.ts` | 71-74 | Calculates maximum recording duration in minutes based on bitrate and file size limit. | `src/commands/summarizeCommands.ts`, `src/ui/modals/AudioRecorderModal.ts`, `src/ui/modals/MinutesCreationModal.ts`, +2 more |
| [`isRecordingSupported`](../src/services/audioRecordingService.ts#L39) | function | `src/services/audioRecordingService.ts` | 39-45 | Checks if the browser supports audio recording via MediaRecorder and getUserMedia. | `src/commands/summarizeCommands.ts`, `src/ui/modals/AudioRecorderModal.ts`, `src/ui/modals/MinutesCreationModal.ts`, +2 more |
| [`mapMimeToExtension`](../src/services/audioRecordingService.ts#L28) | function | `src/services/audioRecordingService.ts` | 28-33 | Maps MIME types to file extensions for audio recording. | `src/commands/summarizeCommands.ts`, `src/ui/modals/AudioRecorderModal.ts`, `src/ui/modals/MinutesCreationModal.ts`, +2 more |
| [`selectMime`](../src/services/audioRecordingService.ts#L52) | function | `src/services/audioRecordingService.ts` | 52-65 | Selects the best supported MIME type and file extension for MediaRecorder. | `src/commands/summarizeCommands.ts`, `src/ui/modals/AudioRecorderModal.ts`, `src/ui/modals/MinutesCreationModal.ts`, +2 more |
...
| [`formatFileSize`](../src/services/audioTranscriptionService.ts#L108) | function | `src/services/audioTranscriptionService.ts` | 108-112 | Formats byte size into human-readable units (B, KB, MB). | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/audioCompressionService.ts`, +11 more |
| [`getAllAudioFiles`](../src/services/audioTranscriptionService.ts#L93) | function | `src/services/audioTranscriptionService.ts` | 93-96 | Retrieves all audio files from the entire vault. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/audioCompressionService.ts`, +11 more |
| [`getAudioFilesFromFolder`](../src/services/audioTranscriptionService.ts#L83) | function | `src/services/audioTranscriptionService.ts` | 83-88 | Retrieves all audio files from a specified vault folder. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/audioCompressionService.ts`, +11 more |
| [`getAudioMimeType`](../src/services/audioTranscriptionService.ts#L117) | function | `src/services/audioTranscriptionService.ts` | 117-130 | Maps audio file extensions to their MIME types. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/audioCompressionService.ts`, +11 more |
...
| [`isAudioFile`](../src/services/audioTranscriptionService.ts#L75) | function | `src/services/audioTranscriptionService.ts` | 75-78 | Checks if a file is in a supported audio format by extension. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/audioCompressionService.ts`, +11 more |
...
| [`CloudLLMService`](../src/services/cloudService.ts#L13) | class | `src/services/cloudService.ts` | 13-784 | <no body> | `src/commands/flashcardCommands.ts`, `src/commands/summarizeCommands.ts`, `src/services/contentExtractionService.ts`, +8 more |
...
| [`assessContent`](../src/services/contentSizePolicy.ts#L124) | function | `src/services/contentSizePolicy.ts` | 124-161 | Assesses text size against chunking thresholds and returns a strategy (direct, chunk, or hierarchical) with estimated chunk count. | `src/commands/summarizeCommands.ts`, `src/services/azure/azureTriageRouting.ts`, `src/services/chunkingOrchestrator.ts`, +1 more |
| [`estimateCharsPerToken`](../src/services/contentSizePolicy.ts#L101) | function | `src/services/contentSizePolicy.ts` | 101-113 | Estimates characters per token by detecting CJK or code-heavy content; defaults to 4 chars/token for Latin text. | `src/commands/summarizeCommands.ts`, `src/services/azure/azureTriageRouting.ts`, `src/services/chunkingOrchestrator.ts`, +1 more |
| [`exceedsProviderHardLimit`](../src/services/contentSizePolicy.ts#L203) | function | `src/services/contentSizePolicy.ts` | 203-205 | Returns true if content length exceeds the provider's hard character limit. | `src/commands/summarizeCommands.ts`, `src/services/azure/azureTriageRouting.ts`, `src/services/chunkingOrchestrator.ts`, +1 more |
| [`getHierarchicalThreshold`](../src/services/contentSizePolicy.ts#L89) | function | `src/services/contentSizePolicy.ts` | 89-93 | Returns the hierarchical reduction threshold based on whether content is minutes or general summarization. | `src/commands/summarizeCommands.ts`, `src/services/azure/azureTriageRouting.ts`, `src/services/chunkingOrchestrator.ts`, +1 more |
| [`getQualityChunkThreshold`](../src/services/contentSizePolicy.ts#L69) | function | `src/services/contentSizePolicy.ts` | 69-86 | Returns the character threshold for quality chunking based on content type and user settings. | `src/commands/summarizeCommands.ts`, `src/services/azure/azureTriageRouting.ts`, `src/services/chunkingOrchestrator.ts`, +1 more |
...
| [`DocumentExtractionService`](../src/services/documentExtractionService.ts#L25) | class | `src/services/documentExtractionService.ts` | 25-380 | <no body> | `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, +4 more |
...
| [`getLanguageByCode`](../src/services/languages.ts#L61) | function | `src/services/languages.ts` | 61-63 | Looks up a language object by its code. | `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, `src/services/minutesService.ts`, +10 more |
| [`getLanguageDisplayName`](../src/services/languages.ts#L48) | function | `src/services/languages.ts` | 48-56 | Returns a human-readable language name, optionally including its native name if different. | `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, `src/services/minutesService.ts`, +10 more |
| [`getLanguageNameForPrompt`](../src/services/languages.ts#L68) | function | `src/services/languages.ts` | 68-74 | Gets a language name suitable for inclusion in an LLM prompt, returning undefined for auto-detect. | `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, `src/services/minutesService.ts`, +10 more |
...
| [`getServiceType`](../src/services/llmFacade.ts#L28) | function | `src/services/llmFacade.ts` | 28-40 | Determines the current LLM service type (cloud or local) and its provider based on settings. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
| [`isMultimodalService`](../src/services/llmFacade.ts#L23) | function | `src/services/llmFacade.ts` | 23-26 | Checks whether a service implements the multimodal LLM interface with both required methods. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
| [`pluginContext`](../src/services/llmFacade.ts#L46) | function | `src/services/llmFacade.ts` | 46-48 | Retrieves the plugin context containing the LLM service and current settings. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
| [`sendMultimodal`](../src/services/llmFacade.ts#L116) | function | `src/services/llmFacade.ts` | 116-137 | Sends multimodal analysis request to cloud provider only, validates capability, and returns error if unsupported. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
| [`summarizeText`](../src/services/llmFacade.ts#L50) | function | `src/services/llmFacade.ts` | 50-61 | Wraps LLM text summarization with error handling and returns success/error response object. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
| [`summarizeTextStream`](../src/services/llmFacade.ts#L65) | function | `src/services/llmFacade.ts` | 65-114 | Streams LLM summarization output via chunks, prevents mid-stream fallback to avoid duplication, and handles abortion. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +25 more |
...
| [`ensurePrivacyConsent`](../src/services/privacyNotice.ts#L57) | function | `src/services/privacyNotice.ts` | 57-73 | Prompts user for privacy consent before using cloud providers, returning their decision. | `src/commands/audioNarrationCommands.ts`, `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, +12 more |
| [`isCloudProvider`](../src/services/privacyNotice.ts#L38) | function | `src/services/privacyNotice.ts` | 38-51 | Checks if a service provider is a cloud-based AI service. | `src/commands/audioNarrationCommands.ts`, `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, +12 more |
| [`markPrivacyNoticeShown`](../src/services/privacyNotice.ts#L31) | function | `src/services/privacyNotice.ts` | 31-33 | Records that the privacy notice has been shown during the current session. | `src/commands/audioNarrationCommands.ts`, `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, +12 more |
| [`resetPrivacyNotice`](../src/services/privacyNotice.ts#L15) | function | `src/services/privacyNotice.ts` | 15-17 | Resets the session flag to allow re-displaying the privacy notice. | `src/commands/audioNarrationCommands.ts`, `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, +12 more |
...
| [`extractSpeakerNames`](../src/services/speakerLabellingService.ts#L217) | function | `src/services/speakerLabellingService.ts` | 217-235 | Extracts unique speaker names from a transcript by matching "Name:" and "[Name]:" label patterns. | `src/services/minutesService.ts`, `src/ui/modals/MinutesCreationModal.ts`, `src/ui/modals/TranscribeOnlyModal.ts` |
| [`hasExistingSpeakerLabels`](../src/services/speakerLabellingService.ts#L42) | function | `src/services/speakerLabellingService.ts` | 42-55 | Detects if a transcript already has speaker labels by checking the ratio of labelled lines against a regex pattern. | `src/services/minutesService.ts`, `src/ui/modals/MinutesCreationModal.ts`, `src/ui/modals/TranscribeOnlyModal.ts` |
| [`labelSegment`](../src/services/speakerLabellingService.ts#L119) | function | `src/services/speakerLabellingService.ts` | 119-164 | Labels a single transcript segment using an LLM prompt and extracts speaker names from the response. | `src/services/minutesService.ts`, `src/ui/modals/MinutesCreationModal.ts`, `src/ui/modals/TranscribeOnlyModal.ts` |
| [`labelSpeakers`](../src/services/speakerLabellingService.ts#L64) | function | `src/services/speakerLabellingService.ts` | 64-114 | Labels speakers in a transcript by detecting existing labels or using LLM segmentation for long transcripts, gathering speaker names and unknown counts. | `src/services/minutesService.ts`, `src/ui/modals/MinutesCreationModal.ts`, `src/ui/modals/TranscribeOnlyModal.ts` |
| [`splitIntoSegments`](../src/services/speakerLabellingService.ts#L169) | function | `src/services/speakerLabellingService.ts` | 169-211 | Splits text into segments by paragraph boundaries first, then by sentence boundaries for oversized paragraphs. | `src/services/minutesService.ts`, `src/ui/modals/MinutesCreationModal.ts`, `src/ui/modals/TranscribeOnlyModal.ts` |
| [`resolveForProvider`](../src/services/specialistModelResolver.ts#L33) | function | `src/services/specialistModelResolver.ts` | 33-41 | Resolves a specialist model for a provider by checking live cache and static model IDs. | `src/services/presentationIr/presentationModelResolver.ts`, `src/services/youtubeService.ts`, `src/ui/modals/MinutesCreationModal.ts` |
| [`resolveSlideTierModel`](../src/services/specialistModelResolver.ts#L78) | function | `src/services/specialistModelResolver.ts` | 78-89 | Resolves a slide tier model by returning either the main model (quality tier) or a fast sentinel model. | `src/services/presentationIr/presentationModelResolver.ts`, `src/services/youtubeService.ts`, `src/ui/modals/MinutesCreationModal.ts` |
...
| [`estimateTokens`](../src/services/tokenLimits.ts#L80) | function | `src/services/tokenLimits.ts` | 80-83 | Estimates text tokens using provider-specific characters-per-token ratio. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`findBoundaryPosition`](../src/services/tokenLimits.ts#L108) | function | `src/services/tokenLimits.ts` | 108-136 | Finds a safe truncation boundary (paragraph, sentence, or word) within a position threshold. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`getMaxContentChars`](../src/services/tokenLimits.ts#L47) | function | `src/services/tokenLimits.ts` | 47-51 | Calculates maximum content characters based on provider limits, overhead, and output reserve. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`getMaxContentCharsForModel`](../src/services/tokenLimits.ts#L57) | function | `src/services/tokenLimits.ts` | 57-63 | Calculates maximum content characters for a specific model, using model override if available. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`getModelInputTokens`](../src/services/tokenLimits.ts#L33) | function | `src/services/tokenLimits.ts` | 33-42 | Returns 1M context tokens for Claude models with 1M context, otherwise null to use provider defaults. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`getProviderLimits`](../src/services/tokenLimits.ts#L96) | function | `src/services/tokenLimits.ts` | 96-98 | Returns the token/character limits object for a provider. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`getTranslationChunkChars`](../src/services/tokenLimits.ts#L71) | function | `src/services/tokenLimits.ts` | 71-75 | Returns the maximum character chunk size for translation operations within output token limits. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`isContentTooLarge`](../src/services/tokenLimits.ts#L88) | function | `src/services/tokenLimits.ts` | 88-91 | Checks if content exceeds the maximum allowable character length for a provider. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`truncateAtBoundary`](../src/services/tokenLimits.ts#L142) | function | `src/services/tokenLimits.ts` | 142-156 | Truncates text at a semantic boundary while preserving an optional suffix. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
| [`truncateContent`](../src/services/tokenLimits.ts#L161) | function | `src/services/tokenLimits.ts` | 161-164 | Truncates content to fit within provider's maximum character limit. | `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, `src/commands/summarizeCommands.ts`, +19 more |
...
| [`VisionService`](../src/services/visionService.ts#L33) | class | `src/services/visionService.ts` | 33-316 | Service for digitizing images into structured Markdown and Mermaid diagrams using multimodal LLM processing. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/summarizeCommands.ts`, +4 more |
...
| [`chunkContent`](../src/services/webContentService.ts#L382) | function | `src/services/webContentService.ts` | 382-384 | <no body> | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/contentExtractionService.ts`, +3 more |
...
| [`parseHTML`](../src/services/webContentService.ts#L70) | function | `src/services/webContentService.ts` | 70-80 | Parses HTML string using DOMParser and sets the base URL for resolving relative links. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/contentExtractionService.ts`, +3 more |
...
| [`fetchVideoInfo`](../src/services/youtubeService.ts#L164) | function | `src/services/youtubeService.ts` | 164-197 | Fetches YouTube video metadata (title and channel name) by parsing the watch page HTML. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/contentExtractionService.ts`, +3 more |
...
| [`getYouTubeUrl`](../src/services/youtubeService.ts#L153) | function | `src/services/youtubeService.ts` | 153-155 | Constructs a standard YouTube watch URL from a video ID. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/contentExtractionService.ts`, +3 more |
| [`isYouTubeUrl`](../src/services/youtubeService.ts#L146) | function | `src/services/youtubeService.ts` | 146-148 | Checks if a URL is a valid YouTube URL by attempting to extract a video ID. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/contentExtractionService.ts`, +3 more |
...
> The `src` domain provides an Obsidian plugin that organizes notes using AI and includes a utility function to format elapsed time for user-facing notices.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`AIOrganiserPlugin`](../src/main.ts#L74) | class | `src/main.ts` | 74-1863 | <no body> | _(internal)_ |
| [`formatElapsedForNotice`](../src/main.ts#L1865) | function | `src/main.ts` | 1865-1870 | Formats milliseconds into a human-readable elapsed time string (e.g., "1m 30s"). | _(internal)_ |

---

## tests

> The `tests` domain provides factory functions and mock utilities for creating test doubles of core application objects—including Obsidian plugin instances, files, services (embedding, audio narration), and configuration objects—enabling isolated unit testing across the codebase.
...
subgraph dom_tests ["tests"]
  ...
  file_tests_azureMode_test_ts["tests/azureMode.test.ts"]:::component
  sym_tests_azureMode_test_ts_makePlugin["makePlugin"]:::symbol
  file_tests_azureMode_test_ts --> sym_tests_azureMode_test_ts_makePlugin
...
_Domain has 228 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`makePlugin`](../tests/azureMode.test.ts#L37) | function | `tests/azureMode.test.ts` | 37-60 | Creates a mock plugin object with test settings and a secret storage service for testing. | _(internal)_ |
...
| [`makeSettings`](../tests/embeddingServiceFactory.test.ts#L23) | function | `tests/embeddingServiceFactory.test.ts` | 23-35 | Creates a test settings object with embedding configuration, optionally merged with overrides. | _(internal)_ |
...
| [`dispatchClick`](../tests/localOnnxConsentModal.test.ts#L23) | function | `tests/localOnnxConsentModal.test.ts` | 23-25 | Dispatches a click event on a mock element for testing event handlers. | _(internal)_ |
| [`makeApp`](../tests/localOnnxConsentModal.test.ts#L15) | function | `tests/localOnnxConsentModal.test.ts` | 15-17 | Creates a new mock App instance for testing. | _(internal)_ |
...
| [`mockEmbeddingService`](../tests/semanticSearchPlan.test.ts#L22) | function | `tests/semanticSearchPlan.test.ts` | 22-33 | Mock embedding service returning fake embeddings, model info, and connection test results. | _(internal)_ |
| [`makeSection`](../tests/semanticSearchSettingsSection.test.ts#L46) | function | `tests/semanticSearchSettingsSection.test.ts` | 46-87 | Creates a configured SemanticSearchSettingsSection instance with mock plugin and settings for testing. | _(internal)_ |
...
| [`buildCsv`](../tests/spreadsheetService.test.ts#L38) | function | `tests/spreadsheetService.test.ts` | 38-41 | Converts CSV text to an ArrayBuffer for testing spreadsheet operations. | _(internal)_ |
| [`buildWorkbook`](../tests/spreadsheetService.test.ts#L16) | function | `tests/spreadsheetService.test.ts` | 16-28 | Builds an Excel workbook from sheet data using SheetJS library and returns it as an ArrayBuffer. | _(internal)_ |
| [`buildXls`](../tests/spreadsheetService.test.ts#L34) | function | `tests/spreadsheetService.test.ts` | 34-36 | Builds and returns an XLS-format spreadsheet as an ArrayBuffer. | _(internal)_ |
| [`buildXlsx`](../tests/spreadsheetService.test.ts#L30) | function | `tests/spreadsheetService.test.ts` | 30-32 | Builds and returns an XLSX-format spreadsheet as an ArrayBuffer. | _(internal)_ |
...
| [`meetsMinimumVersion`](../tests/verifyPptxXmldomCompat.test.ts#L48) | function | `tests/verifyPptxXmldomCompat.test.ts` | 48-53 | Compares a semantic version string against a minimum required version (major.minor.patch format). | _(internal)_ |
| [`xmldomVersion`](../tests/verifyPptxXmldomCompat.test.ts#L40) | function | `tests/verifyPptxXmldomCompat.test.ts` | 40-43 | Retrieves the version string from the @xmldom/xmldom package.json file. | _(internal)_ |
...
> The `tests-mocks` domain provides mock implementations of Obsidian API classes (TFile, TFolder, Editor, MarkdownView, Notice) and a mock SecretStorage for testing, enabling unit tests to simulate file system operations, UI components, and secure storage without requiring a live Obsidian environment.
...
subgraph dom_tests_mocks ["tests-mocks"]
  ...
  sym_tests_mocks_obsidian_ts_AbstractInputSug["AbstractInputSuggest"]:::symbol
  file_tests_mocks_obsidian_ts --> sym_tests_mocks_obsidian_ts_AbstractInputSug
  ...
  sym_tests_mocks_obsidian_ts_Editor["Editor"]:::symbol
  file_tests_mocks_obsidian_ts --> sym_tests_mocks_obsidian_ts_Editor
  ...
  sym_tests_mocks_obsidian_ts_MarkdownView["MarkdownView"]:::symbol
  file_tests_mocks_obsidian_ts --> sym_tests_mocks_obsidian_ts_MarkdownView
  ...
  sym_tests_mocks_obsidian_ts_MockSlider["MockSlider"]:::symbol
  file_tests_mocks_obsidian_ts --> sym_tests_mocks_obsidian_ts_MockSlider
  ...
  sym_tests_mocks_obsidian_ts_setTooltip["setTooltip"]:::symbol
  file_tests_mocks_obsidian_ts --> sym_tests_mocks_obsidian_ts_setTooltip
...
| [`AbstractInputSuggest`](../tests/mocks/obsidian.ts#L54) | class | `tests/mocks/obsidian.ts` | 54-67 | Provides base functionality for input suggestion dropdowns with text input binding, value management, and selection callbacks. | _(internal)_ |
| [`App`](../tests/mocks/obsidian.ts#L111) | class | `tests/mocks/obsidian.ts` | 111-149 | Core app object providing access to vault, metadata cache, workspace, and other application-wide services. | _(internal)_ |
| [`clearMockNotices`](../tests/mocks/obsidian.ts#L98) | function | `tests/mocks/obsidian.ts` | 98-100 | Clears all mock notice entries. | _(internal)_ |
| [`createTFile`](../tests/mocks/obsidian.ts#L20) | function | `tests/mocks/obsidian.ts` | 20-28 | Creates a mock TFile object with a given path. | _(internal)_ |
| [`createTFolder`](../tests/mocks/obsidian.ts#L43) | function | `tests/mocks/obsidian.ts` | 43-48 | Creates a mock TFolder object with a given path. | _(internal)_ |
| [`Editor`](../tests/mocks/obsidian.ts#L103) | class | `tests/mocks/obsidian.ts` | 103-103 | Mock Editor class with no implementation. | _(internal)_ |
| [`FuzzySuggestModal`](../tests/mocks/obsidian.ts#L304) | class | `tests/mocks/obsidian.ts` | 304-315 | Fuzzy-searchable modal for selecting from a list of items with customizable text and instructions. | _(internal)_ |
| [`ItemView`](../tests/mocks/obsidian.ts#L289) | class | `tests/mocks/obsidian.ts` | 289-302 | Base class for custom views displayed in workspace leaves with lifecycle methods. | _(internal)_ |
| [`MarkdownView`](../tests/mocks/obsidian.ts#L106) | class | `tests/mocks/obsidian.ts` | 106-109 | Represents a markdown view containing a file reference and associated editor instance. | _(internal)_ |
| [`MockButton`](../tests/mocks/obsidian.ts#L455) | class | `tests/mocks/obsidian.ts` | 455-475 | Button component with text, click handler, and styling options like CTA and warning states. | _(internal)_ |
| [`MockDropdown`](../tests/mocks/obsidian.ts#L422) | class | `tests/mocks/obsidian.ts` | 422-445 | Dropdown select component that stores options and manages selected value with change callbacks. | _(internal)_ |
| [`MockHTMLElement`](../tests/mocks/obsidian.ts#L152) | class | `tests/mocks/obsidian.ts` | 152-244 | <no body> | _(internal)_ |
| [`MockSlider`](../tests/mocks/obsidian.ts#L447) | class | `tests/mocks/obsidian.ts` | 447-453 | Slider component with configurable limits, step size, and dynamic tooltip support. | _(internal)_ |
| [`MockTextAreaComponent`](../tests/mocks/obsidian.ts#L418) | class | `tests/mocks/obsidian.ts` | 418-420 | Text area input component extending text component functionality. | _(internal)_ |
| [`MockTextComponent`](../tests/mocks/obsidian.ts#L399) | class | `tests/mocks/obsidian.ts` | 399-416 | Text input component that manages string value and triggers callbacks on changes. | _(internal)_ |
| [`MockToggle`](../tests/mocks/obsidian.ts#L371) | class | `tests/mocks/obsidian.ts` | 371-397 | Toggle switch component that tracks state and notifies on changes via callback. | _(internal)_ |
| [`Modal`](../tests/mocks/obsidian.ts#L246) | class | `tests/mocks/obsidian.ts` | 246-273 | Base modal dialog class with content, title elements, and open/close state management. | _(internal)_ |
| [`normalizePath`](../tests/mocks/obsidian.ts#L477) | function | `tests/mocks/obsidian.ts` | 477-479 | Normalizes a file path by converting backslashes to forward slashes and collapsing consecutive slashes. | _(internal)_ |
| [`Notice`](../tests/mocks/obsidian.ts#L69) | class | `tests/mocks/obsidian.ts` | 69-95 | Creates dismissible notification messages that can be displayed to users with optional timeouts and visibility control. | _(internal)_ |
| [`Plugin`](../tests/mocks/obsidian.ts#L496) | class | `tests/mocks/obsidian.ts` | 496-510 | Base plugin class providing app reference, manifest data, and plugin lifecycle methods. | _(internal)_ |
| [`PluginSettingTab`](../tests/mocks/obsidian.ts#L512) | class | `tests/mocks/obsidian.ts` | 512-523 | Settings tab container for plugins to display configuration UI. | _(internal)_ |
| [`setIcon`](../tests/mocks/obsidian.ts#L481) | function | `tests/mocks/obsidian.ts` | 481-483 | <no body> | _(internal)_ |
| [`Setting`](../tests/mocks/obsidian.ts#L317) | class | `tests/mocks/obsidian.ts` | 317-369 | Builder for creating settings UI with name, description, and various input component types. | _(internal)_ |
| [`setTooltip`](../tests/mocks/obsidian.ts#L485) | function | `tests/mocks/obsidian.ts` | 485-487 | <no body> | _(internal)_ |
| [`TFile`](../tests/mocks/obsidian.ts#L9) | class | `tests/mocks/obsidian.ts` | 9-17 | Represents a file object with metadata like path, basename, extension, timestamps, and parent folder reference. | _(internal)_ |
| [`TFolder`](../tests/mocks/obsidian.ts#L30) | class | `tests/mocks/obsidian.ts` | 30-40 | Represents a folder object with path, name, child files/folders, and methods to check if it's the root directory. | _(internal)_ |
| [`WorkspaceLeaf`](../tests/mocks/obsidian.ts#L275) | class | `tests/mocks/obsidian.ts` | 275-287 | Represents a workspace leaf (pane) that holds a view within the editor. | _(internal)_ |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`CryptoUnavailableError`](../src/services/tts/fingerprint.ts#L11) | class | `src/services/tts/fingerprint.ts` | 11-17 | Custom error thrown when Web Crypto API is unavailable on the platform. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/vector/attachmentFingerprint.ts` |
| [`sha256Hex`](../src/services/tts/fingerprint.ts#L29) | function | `src/services/tts/fingerprint.ts` | 29-53 | Computes SHA-256 hash of length-prefixed concatenated strings using Web Crypto API. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/vector/attachmentFingerprint.ts` |
...
| [`applyGainWithLimit`](../src/services/tts/pcmUtils.ts#L139) | function | `src/services/tts/pcmUtils.ts` | 139-161 | Applies block-interpolated gain to PCM samples with hard peak limiting. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`base64ToUint8Array`](../src/services/tts/pcmUtils.ts#L190) | function | `src/services/tts/pcmUtils.ts` | 190-197 | Converts base64 string to Uint8Array byte buffer. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`clampGain`](../src/services/tts/pcmUtils.ts#L82) | function | `src/services/tts/pcmUtils.ts` | 82-84 | Clamps gain value between minimum and maximum allowed normalization bounds. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`computeBlockRms`](../src/services/tts/pcmUtils.ts#L87) | function | `src/services/tts/pcmUtils.ts` | 87-100 | Computes root-mean-square amplitude for each block of PCM samples. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`computeDesiredGain`](../src/services/tts/pcmUtils.ts#L104) | function | `src/services/tts/pcmUtils.ts` | 104-117 | Calculates target gain per block by dividing target RMS by current block RMS, with silence handling. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`downsamplePcm16`](../src/services/tts/pcmUtils.ts#L26) | function | `src/services/tts/pcmUtils.ts` | 26-57 | Resamples PCM audio by averaging groups of input samples to match target sample rate. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`dynamicNormalize`](../src/services/tts/pcmUtils.ts#L171) | function | `src/services/tts/pcmUtils.ts` | 171-184 | Normalizes PCM audio by computing block RMS, desired gain, smoothing, and applying limited gain. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`pcmBytesToInt16`](../src/services/tts/pcmUtils.ts#L14) | function | `src/services/tts/pcmUtils.ts` | 14-18 | Interprets byte buffer as Int16 PCM samples. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
| [`smoothGain`](../src/services/tts/pcmUtils.ts#L122) | function | `src/services/tts/pcmUtils.ts` | 122-136 | Smooths gain changes across blocks using exponential attack/release coefficients and applies headroom. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/newsletter/newsletterAudioService.ts`, `src/services/tts/azureSpeechTtsEngine.ts`, +3 more |
...
| [`abortableSleep`](../src/services/tts/ttsRetry.ts#L50) | function | `src/services/tts/ttsRetry.ts` | 50-66 | Sleeps for milliseconds and rejects on abort signal if triggered. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/newsletter/newsletterAudioService.ts` |
| [`computeDelay`](../src/services/tts/ttsRetry.ts#L69) | function | `src/services/tts/ttsRetry.ts` | 69-72 | Computes exponential backoff delay with jitter between base and max milliseconds. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/newsletter/newsletterAudioService.ts` |
| [`isAbort`](../src/services/tts/ttsRetry.ts#L43) | function | `src/services/tts/ttsRetry.ts` | 43-47 | Checks if error is an AbortError from DOM or Error class. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/newsletter/newsletterAudioService.ts` |
| [`isRetryable`](../src/services/tts/ttsRetry.ts#L32) | function | `src/services/tts/ttsRetry.ts` | 32-41 | Determines if error is retryable based on explicit flag, HTTP status codes, or error name. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/newsletter/newsletterAudioService.ts` |
| [`retryWithBackoff`](../src/services/tts/ttsRetry.ts#L74) | function | `src/services/tts/ttsRetry.ts` | 74-99 | Retries operation with exponential backoff, honoring abort signals and calling optional retry callback. | `src/services/audioNarration/audioNarrationService.ts`, `src/services/audioNarration/llmMarkdownEnhancer.ts`, `src/services/newsletter/newsletterAudioService.ts` |

---

## ui

> The `ui` domain builds interactive components for audio playback control (speed adjustment), secure iframe-based slide previews with DOM manipulation, and progress indicators for tagging operations.
...
_Domain has 170 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`generateNonce`](../src/ui/components/SlideIframePreview.ts#L66) | function | `src/ui/components/SlideIframePreview.ts` | 66-70 | Generates a cryptographic nonce for CSP compliance in iframe postMessage communication. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationCanvasView.ts` |
| [`isAllowedCssProperty`](../src/ui/components/SlideIframePreview.ts#L48) | function | `src/ui/components/SlideIframePreview.ts` | 48-50 | Checks if a CSS property name is in the allowlist of safe properties that can be fixed via DOM injection. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationCanvasView.ts` |
| [`isSafeCssValue`](../src/ui/components/SlideIframePreview.ts#L52) | function | `src/ui/components/SlideIframePreview.ts` | 52-54 | Checks if a CSS value string contains dangerous patterns that could enable XSS or injection attacks. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationCanvasView.ts` |
| [`sanitizeCssSelector`](../src/ui/components/SlideIframePreview.ts#L19) | function | `src/ui/components/SlideIframePreview.ts` | 19-27 | Validates a CSS selector string to prevent injection attacks and enforce reasonable length limits. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationCanvasView.ts` |
| [`SlideIframePreview`](../src/ui/components/SlideIframePreview.ts#L98) | class | `src/ui/components/SlideIframePreview.ts` | 98-581 | Manages an iframe-based slide preview with navigation, keyboard control, quality indicators, and DOM fixes. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/presentationCanvasView.ts` |
...
| [`buildCommandCategories`](../src/ui/modals/CommandPickerModal.ts#L671) | function | `src/ui/modals/CommandPickerModal.ts` | 671-966 | <no body> | `src/main.ts`, `src/ui/settings/InterfaceSettingsSection.ts`, `src/ui/settings/QuickCommandsSettingsSection.ts` |
| [`CommandPickerModal`](../src/ui/modals/CommandPickerModal.ts#L53) | class | `src/ui/modals/CommandPickerModal.ts` | 53-630 | <no body> | `src/main.ts`, `src/ui/settings/InterfaceSettingsSection.ts`, `src/ui/settings/QuickCommandsSettingsSection.ts` |
| [`findLeafByIdInCategories`](../src/ui/modals/CommandPickerModal.ts#L655) | function | `src/ui/modals/CommandPickerModal.ts` | 655-669 | Recursively searches categories and subcommands for a command matching the given ID. | `src/main.ts`, `src/ui/settings/InterfaceSettingsSection.ts`, `src/ui/settings/QuickCommandsSettingsSection.ts` |
...
| [`FolderScopePickerModal`](../src/ui/modals/FolderScopePickerModal.ts#L57) | class | `src/ui/modals/FolderScopePickerModal.ts` | 57-430 | <no body> | `src/commands/canvasCommands.ts`, `src/commands/semanticSearchCommands.ts`, `src/ui/chat/ResearchModeHandler.ts`, +5 more |
| [`normalizeCreatePath`](../src/ui/modals/FolderScopePickerModal.ts#L16) | function | `src/ui/modals/FolderScopePickerModal.ts` | 16-21 | Normalizes a search term by trimming and removing leading/trailing slashes for path creation. | `src/commands/canvasCommands.ts`, `src/commands/semanticSearchCommands.ts`, `src/ui/chat/ResearchModeHandler.ts`, +5 more |
| [`shouldShowCreateFolder`](../src/ui/modals/FolderScopePickerModal.ts#L28) | function | `src/ui/modals/FolderScopePickerModal.ts` | 28-36 | Determines whether to show a "create new folder" option based on search term and matching results. | `src/commands/canvasCommands.ts`, `src/commands/semanticSearchCommands.ts`, `src/ui/chat/ResearchModeHandler.ts`, +5 more |
...
| [`LocalOnnxConsentModal`](../src/ui/modals/LocalOnnxConsentModal.ts#L20) | class | `src/ui/modals/LocalOnnxConsentModal.ts` | 20-82 | Modal dialog requesting user consent before enabling local ONNX embeddings with accept/decline options. | `src/ui/settings/SemanticSearchSettingsSection.ts` |
...
| [`SemanticSearchSettingsSection`](../src/ui/settings/SemanticSearchSettingsSection.ts#L11) | class | `src/ui/settings/SemanticSearchSettingsSection.ts` | 11-561 | <no body> | `src/ui/settings/AIOrganiserSettingTab.ts` |
...
| [`listen`](../src/ui/utils/domUtils.ts#L5) | function | `src/ui/utils/domUtils.ts` | 5-13 | Attaches event listener to element and returns cleanup function for removal. | `src/ui/components/AudioAttachHelper.ts`, `src/ui/components/ScopedFilePickerHeader.ts`, `src/ui/components/SectionAssignmentSelect.ts`, +19 more |
...
| [`addModePill`](../src/ui/chat/presentation/EditAccessories.ts#L146) | function | `src/ui/chat/presentation/EditAccessories.ts` | 146-187 | Creates an interactive edit mode button with keyboard navigation and auto-focus behavior. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`describeScope`](../src/ui/chat/presentation/EditAccessories.ts#L111) | function | `src/ui/chat/presentation/EditAccessories.ts` | 111-125 | Generates a human-readable label describing the selected slide scope (single, range, or element). | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`handleModeKeydown`](../src/ui/chat/presentation/EditAccessories.ts#L189) | function | `src/ui/chat/presentation/EditAccessories.ts` | 189-203 | Handles arrow keys and space/enter for navigating and activating the edit mode radio group. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`renderEditAccessories`](../src/ui/chat/presentation/EditAccessories.ts#L41) | function | `src/ui/chat/presentation/EditAccessories.ts` | 41-72 | Renders edit mode accessories (selection pill, mode pills, flags) for controlling slide editing behavior. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`renderEditFlags`](../src/ui/chat/presentation/EditAccessories.ts#L207) | function | `src/ui/chat/presentation/EditAccessories.ts` | 207-222 | Renders a checkbox for toggling web search during presentation editing. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`renderModePills`](../src/ui/chat/presentation/EditAccessories.ts#L129) | function | `src/ui/chat/presentation/EditAccessories.ts` | 129-138 | Creates radio buttons for switching between content and design editing modes. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
| [`renderSelectionPill`](../src/ui/chat/presentation/EditAccessories.ts#L76) | function | `src/ui/chat/presentation/EditAccessories.ts` | 76-109 | Renders a focusable pill displaying the current selection with a clear button and keyboard support. | `src/ui/chat/PresentationModeHandler.ts`, `src/ui/chat/presentation/editScopeController.ts` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`abortableRequestUrl`](../src/utils/abortableRequestUrl.ts#L25) | function | `src/utils/abortableRequestUrl.ts` | 25-53 | Makes an HTTP request with abort signal support by racing the request against an abort promise. | `src/services/audioNarration/llmEnhancerProvider.ts`, `src/services/audioTranscriptionService.ts`, `src/services/diarization/deepgramAdapter.ts`, +5 more |
...
| [`hideBusy`](../src/utils/busyIndicator.ts#L70) | function | `src/utils/busyIndicator.ts` | 70-97 | Hides the busy spinner with reference counting and deferred hiding to ensure minimum visibility time. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +10 more |
| [`resetBusyState`](../src/utils/busyIndicator.ts#L119) | function | `src/utils/busyIndicator.ts` | 119-131 | Resets all busy indicator state and clears pending timers. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +10 more |
| [`showBusy`](../src/utils/busyIndicator.ts#L34) | function | `src/utils/busyIndicator.ts` | 34-63 | Shows a busy spinner in the status bar with reference counting, watchdog timer, and minimum display duration. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +10 more |
| [`withBusyIndicator`](../src/utils/busyIndicator.ts#L103) | function | `src/utils/busyIndicator.ts` | 103-114 | Wraps an async operation with automatic busy indicator display and cleanup. | `src/commands/canvasCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +10 more |
...
| [`desktopRequire`](../src/utils/desktopRequire.ts#L7) | function | `src/utils/desktopRequire.ts` | 7-10 | Safely requires a module in desktop environment, returning undefined if unavailable. | `src/commands/flashcardCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +10 more |
| [`getElectron`](../src/utils/desktopRequire.ts#L38) | function | `src/utils/desktopRequire.ts` | 38-40 | Returns the Electron module via desktop require. | `src/commands/flashcardCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +10 more |
| [`getFs`](../src/utils/desktopRequire.ts#L19) | function | `src/utils/desktopRequire.ts` | 19-21 | Returns the Node.js fs module via desktop require. | `src/commands/flashcardCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +10 more |
| [`getOs`](../src/utils/desktopRequire.ts#L27) | function | `src/utils/desktopRequire.ts` | 27-29 | Returns the Node.js os module via desktop require. | `src/commands/flashcardCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +10 more |
| [`getPath`](../src/utils/desktopRequire.ts#L23) | function | `src/utils/desktopRequire.ts` | 23-25 | Returns the Node.js path module via desktop require. | `src/commands/flashcardCommands.ts`, `src/commands/minutesCommands.ts`, `src/commands/notebookLMCommands.ts`, +10 more |
| [`buildDigitiseMarkdown`](../src/utils/digitiseUtils.ts#L13) | function | `src/utils/digitiseUtils.ts` | 13-32 | Builds markdown from digitized content including extracted text, diagrams, and uncertainties. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, +1 more |
| [`extractImageText`](../src/utils/digitiseUtils.ts#L54) | function | `src/utils/digitiseUtils.ts` | 54-65 | Extracts text from an image file and returns it as formatted markdown with file reference. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, +1 more |
| [`resolveImageFile`](../src/utils/digitiseUtils.ts#L38) | function | `src/utils/digitiseUtils.ts` | 38-48 | Resolves an image file path using wiki-link resolution then falls back to direct vault lookup. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/services/multiSource/multiSourceOrchestrator.ts`, +1 more |
...
| [`classifyInternalFile`](../src/utils/embeddedContentDetector.ts#L289) | function | `src/utils/embeddedContentDetector.ts` | 289-326 | Classifies internal file references and resolves them, determining type by file extension. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`classifyUrl`](../src/utils/embeddedContentDetector.ts#L208) | function | `src/utils/embeddedContentDetector.ts` | 208-284 | Classifies external URLs into types like YouTube, image, PDF, document, or generic web-link. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`createContentItem`](../src/utils/embeddedContentDetector.ts#L185) | function | `src/utils/embeddedContentDetector.ts` | 185-203 | Classifies a content item as external or internal and returns appropriate content item object. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectBareUrls`](../src/utils/embeddedContentDetector.ts#L161) | function | `src/utils/embeddedContentDetector.ts` | 161-180 | Finds bare HTTP/HTTPS URLs in text that aren't part of existing markdown syntax. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectEmbeddedAudio`](../src/utils/embeddedContentDetector.ts#L436) | function | `src/utils/embeddedContentDetector.ts` | 436-439 | Detects and returns only audio items from embedded content in markdown. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectEmbeddedContent`](../src/utils/embeddedContentDetector.ts#L49) | function | `src/utils/embeddedContentDetector.ts` | 49-80 | Detects and classifies all embedded and linked content in markdown (images, PDFs, YouTube, URLs, files). | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectEmbeddedDocuments`](../src/utils/embeddedContentDetector.ts#L445) | function | `src/utils/embeddedContentDetector.ts` | 445-448 | Detects and returns only document and PDF items from embedded content in markdown. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectEmbeddedSyntax`](../src/utils/embeddedContentDetector.ts#L85) | function | `src/utils/embeddedContentDetector.ts` | 85-112 | Finds embedded markdown `![alt](url)` and wiki `![[file]]` syntax in a line. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`detectLinkSyntax`](../src/utils/embeddedContentDetector.ts#L117) | function | `src/utils/embeddedContentDetector.ts` | 117-156 | Finds markdown `[text](url)` and wiki `[[file]]` link syntax excluding embedded items. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getContentTypeDisplayName`](../src/utils/embeddedContentDetector.ts#L403) | function | `src/utils/embeddedContentDetector.ts` | 403-414 | Returns human-readable display name for an embedded content type. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getContentTypeIcon`](../src/utils/embeddedContentDetector.ts#L419) | function | `src/utils/embeddedContentDetector.ts` | 419-430 | Returns appropriate icon name for an embedded content type. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getExtractableContent`](../src/utils/embeddedContentDetector.ts#L375) | function | `src/utils/embeddedContentDetector.ts` | 375-384 | Returns items that can be extracted and processed (PDFs, documents, YouTube, web, images). | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getFileName`](../src/utils/embeddedContentDetector.ts#L352) | function | `src/utils/embeddedContentDetector.ts` | 352-355 | Extracts the filename from a path by splitting on slashes and taking the last part. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getFileNameFromUrl`](../src/utils/embeddedContentDetector.ts#L338) | function | `src/utils/embeddedContentDetector.ts` | 338-347 | Extracts the filename from a URL by parsing pathname and decoding URI components. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`getQuickPeekSources`](../src/utils/embeddedContentDetector.ts#L390) | function | `src/utils/embeddedContentDetector.ts` | 390-398 | Returns items suitable for quick peek source display (web, YouTube, PDF, document, audio). | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`isExternalUrl`](../src/utils/embeddedContentDetector.ts#L331) | function | `src/utils/embeddedContentDetector.ts` | 331-333 | Checks if a string is an external HTTP or HTTPS URL. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
| [`removeDuplicates`](../src/utils/embeddedContentDetector.ts#L360) | function | `src/utils/embeddedContentDetector.ts` | 360-370 | Removes duplicate items from a list based on type and URL combination. | `src/commands/digitisationCommands.ts`, `src/commands/flashcardCommands.ts`, `src/commands/integrationCommands.ts`, +8 more |
...
| [`Logger`](../src/utils/logger.ts#L7) | class | `src/utils/logger.ts` | 7-26 | Logs debug, warning, and error messages with AI Organiser tag prefix and optional debug mode filtering. | `src/commands/audioNarrationCommands.ts`, `src/commands/digitisationCommands.ts`, `src/commands/embedScanCommands.ts`, +135 more |
...
| [`buildMinutesFrontmatter`](../src/utils/minutesUtils.ts#L92) | function | `src/utils/minutesUtils.ts` | 92-139 | Builds YAML frontmatter for meeting minutes from metadata, participants, and action counts. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`buildMinutesJsonComment`](../src/utils/minutesUtils.ts#L746) | function | `src/utils/minutesUtils.ts` | 746-748 | Encodes meeting JSON as an HTML comment for later extraction. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`buildMinutesMarkdown`](../src/utils/minutesUtils.ts#L160) | function | `src/utils/minutesUtils.ts` | 160-181 | Combines internal markdown and optional external markdown sections, inserting tasks if requested. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`ensureFolderExists`](../src/utils/minutesUtils.ts#L42) | function | `src/utils/minutesUtils.ts` | 42-63 | Recursively creates folder hierarchy in vault, handling race conditions from concurrent operations. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`formatActionsAsObsidianTasks`](../src/utils/minutesUtils.ts#L152) | function | `src/utils/minutesUtils.ts` | 152-158 | Formats meeting actions as Obsidian task bullets with owner and due date annotations. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`formatMinutesCallout`](../src/utils/minutesUtils.ts#L141) | function | `src/utils/minutesUtils.ts` | 141-150 | Wraps content in an Obsidian callout block with type and title. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`formatParticipant`](../src/utils/minutesUtils.ts#L280) | function | `src/utils/minutesUtils.ts` | 280-283 | Formats a participant name with role and organisation in parentheses if present. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`getAvailableFilePath`](../src/utils/minutesUtils.ts#L65) | function | `src/utils/minutesUtils.ts` | 65-90 | Finds an available file path by appending numeric counters until an unused name is found. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`getFileFromVault`](../src/utils/minutesUtils.ts#L757) | function | `src/utils/minutesUtils.ts` | 757-759 | Retrieves a file from vault by path. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`groupPointsBySubTopic`](../src/utils/minutesUtils.ts#L197) | function | `src/utils/minutesUtils.ts` | 197-218 | Groups discussion points by detected financial/operational keywords into sub-topics, or returns all as general. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`hasAnyAgendaRef`](../src/utils/minutesUtils.ts#L414) | function | `src/utils/minutesUtils.ts` | 414-418 | Checks if notable points, decisions, or actions contain references to specific agenda items. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`isMarkdownFile`](../src/utils/minutesUtils.ts#L761) | function | `src/utils/minutesUtils.ts` | 761-763 | Checks if a vault object is a markdown TFile. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`isUsableMarkdown`](../src/utils/minutesUtils.ts#L23) | function | `src/utils/minutesUtils.ts` | 23-28 | Validates that markdown content is substantial enough for minutes (min length, has headers, not JSON/code). | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderAppendix`](../src/utils/minutesUtils.ts#L335) | function | `src/utils/minutesUtils.ts` | 335-370 | Builds an appendix section containing risks, deferred items, and open questions with metadata. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderDetailed`](../src/utils/minutesUtils.ts#L609) | function | `src/utils/minutesUtils.ts` | 609-652 | Renders minutes in detailed style with full header, key points, and item-by-item breakdown including appendix. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderDetailedAgendaGrouped`](../src/utils/minutesUtils.ts#L654) | function | `src/utils/minutesUtils.ts` | 654-732 | Organizes detailed-style content under agenda items with prose paragraphs and compact decision/action tables. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderGTDSection`](../src/utils/minutesUtils.ts#L372) | function | `src/utils/minutesUtils.ts` | 372-412 | Renders GTD (Getting Things Done) sections for next actions grouped by context, waiting-for items, projects, and someday/maybe. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderGuided`](../src/utils/minutesUtils.ts#L736) | function | `src/utils/minutesUtils.ts` | 736-744 | Renders guided-style minutes by using LLM-generated markdown if usable, falling back to standard rendering. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderHeaderBlock`](../src/utils/minutesUtils.ts#L285) | function | `src/utils/minutesUtils.ts` | 285-326 | Builds the header block for minutes including title, metadata (date, time, location, chair), and participant lists. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderMinutesFromJson`](../src/utils/minutesUtils.ts#L231) | function | `src/utils/minutesUtils.ts` | 231-265 | Renders meeting JSON into markdown using selected style (smart-brevity, standard, detailed, guided), then post-processes. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderRisksAsOpportunities`](../src/utils/minutesUtils.ts#L328) | function | `src/utils/minutesUtils.ts` | 328-333 | Renders risks as an "Opportunities and obstacles" section. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderSmartBrevity`](../src/utils/minutesUtils.ts#L422) | function | `src/utils/minutesUtils.ts` | 422-459 | Renders minutes in smart-brevity style: "the big thing", "why it matters", decisions, actions, and deeper dive. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`renderStandard`](../src/utils/minutesUtils.ts#L463) | function | `src/utils/minutesUtils.ts` | 463-514 | Renders minutes in standard style with header, summary, and agenda-grouped or flat sections for decisions/actions. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
...
| [`sanitizeFileName`](../src/utils/minutesUtils.ts#L38) | function | `src/utils/minutesUtils.ts` | 38-40 | Sanitizes a filename by replacing special characters with hyphens. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`stripConfidenceAnnotations`](../src/utils/minutesUtils.ts#L11) | function | `src/utils/minutesUtils.ts` | 11-16 | Removes confidence level annotations from text using regex patterns. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`stripLocalFileImageRefs`](../src/utils/minutesUtils.ts#L270) | function | `src/utils/minutesUtils.ts` | 270-276 | Removes local file:/// image references and Word clipboard artifacts from content. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`yamlEscape`](../src/utils/minutesUtils.ts#L750) | function | `src/utils/minutesUtils.ts` | 750-755 | Escapes and quotes a value for YAML frontmatter, converting newlines to spaces. | `src/commands/minutesCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/summarizeCommands.ts`, +24 more |
| [`addToPendingIntegration`](../src/utils/noteStructure.ts#L395) | function | `src/utils/noteStructure.ts` | 395-411 | Ensures Pending Integration section exists, then inserts formatted source content at its start. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`addToReferencesSection`](../src/utils/noteStructure.ts#L230) | function | `src/utils/noteStructure.ts` | 230-246 | Ensures References section exists, then inserts a formatted source reference at its start. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`analyzeNoteStructure`](../src/utils/noteStructure.ts#L139) | function | `src/utils/noteStructure.ts` | 139-165 | Maps note structure by finding References and Pending Integration sections and determining where main content ends. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`clearPendingIntegration`](../src/utils/noteStructure.ts#L473) | function | `src/utils/noteStructure.ts` | 473-491 | Deletes all content within the Pending Integration section while preserving its header. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
...
| [`ensureNoteStructureIfEnabled`](../src/utils/noteStructure.ts#L507) | function | `src/utils/noteStructure.ts` | 507-514 | Conditionally applies ensureStandardStructure if the autoEnsureNoteStructure setting is enabled. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
...
| [`findSectionInEditor`](../src/utils/noteStructure.ts#L58) | function | `src/utils/noteStructure.ts` | 58-93 | Locates a section header in an editor by pattern matching and finds its content boundaries. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`findSectionInText`](../src/utils/noteStructure.ts#L99) | function | `src/utils/noteStructure.ts` | 99-134 | Locates a section header in text content by pattern matching and finds its content boundaries. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`formatDuration`](../src/utils/noteStructure.ts#L681) | function | `src/utils/noteStructure.ts` | 681-690 | Formats seconds into human-readable HH:MM:SS or MM:SS duration string. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`formatPendingContent`](../src/utils/noteStructure.ts#L384) | function | `src/utils/noteStructure.ts` | 384-389 | Formats a source with its title, date, and link into a markdown ### Source block with content. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
...
| [`getMainContent`](../src/utils/noteStructure.ts#L459) | function | `src/utils/noteStructure.ts` | 459-468 | Extracts and returns all text from the document start through the end of main content (before trailing sections). | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
...
| [`getReferencesContent`](../src/utils/noteStructure.ts#L359) | function | `src/utils/noteStructure.ts` | 359-368 | Retrieves all lines between the References section header and its end boundary. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`getTodayDate`](../src/utils/noteStructure.ts#L674) | function | `src/utils/noteStructure.ts` | 674-676 | Returns today's date as an ISO 8601 string (YYYY-MM-DD). | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`hasPendingIntegrationSection`](../src/utils/noteStructure.ts#L520) | function | `src/utils/noteStructure.ts` | 520-523 | Returns whether the Pending Integration section header exists in the editor. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
| [`hasReferencesSection`](../src/utils/noteStructure.ts#L550) | function | `src/utils/noteStructure.ts` | 550-553 | Returns whether the References section header exists in the editor. | `src/commands/chatCommands.ts`, `src/commands/clearCommands.ts`, `src/commands/generateCommands.ts`, +7 more |
...
| [`createFallbackResponse`](../src/utils/responseParser.ts#L307) | function | `src/utils/responseParser.ts` | 307-342 | Creates a fallback StructuredResponse from plain text by extracting a hook, inferring content type, and mining hashtags. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`extractJsonStringValue`](../src/utils/responseParser.ts#L150) | function | `src/utils/responseParser.ts` | 150-184 | Manually parses a JSON string value by key name, handling escape sequences and literal newlines. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`extractPlainText`](../src/utils/responseParser.ts#L347) | function | `src/utils/responseParser.ts` | 347-349 | Extracts and returns the body_content field from a StructuredResponse object. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`isValidStructuredResponse`](../src/utils/responseParser.ts#L218) | function | `src/utils/responseParser.ts` | 218-250 | Validates a parsed object against the StructuredResponse schema, coercing invalid optional fields to safe defaults. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`parseStructuredResponse`](../src/utils/responseParser.ts#L190) | function | `src/utils/responseParser.ts` | 190-212 | Parses an LLM response into a StructuredResponse by trying multiple extraction strategies and fallback to plain text. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`repairJsonStrings`](../src/utils/responseParser.ts#L55) | function | `src/utils/responseParser.ts` | 55-71 | Replaces literal newline, carriage return, and tab characters inside JSON strings with their escape sequences. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`sanitizeBodyContent`](../src/utils/responseParser.ts#L288) | function | `src/utils/responseParser.ts` | 288-302 | Removes leading markdown links from body content. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`sanitizeSummaryHook`](../src/utils/responseParser.ts#L378) | function | `src/utils/responseParser.ts` | 378-384 | Sanitizes and optionally truncates a summary hook string to a maximum length. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`sanitizeSummaryHookContent`](../src/utils/responseParser.ts#L255) | function | `src/utils/responseParser.ts` | 255-282 | Removes headings, markdown links, URLs, and excess whitespace from summary hooks, truncating to max length. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`splitCompanionContent`](../src/utils/responseParser.ts#L359) | function | `src/utils/responseParser.ts` | 359-372 | Splits companion content delimiter from text, returning both summary and optional companion sections. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`tryExtractJson`](../src/utils/responseParser.ts#L39) | function | `src/utils/responseParser.ts` | 39-47 | Attempts multiple strategies to extract valid JSON from text, including repair of literal newlines in strings. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`tryExtractStructuredFields`](../src/utils/responseParser.ts#L117) | function | `src/utils/responseParser.ts` | 117-144 | Extracts body_content and summary_hook string values and optional fields (tags, type) via regex from malformed JSON. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`tryParseJson`](../src/utils/responseParser.ts#L14) | function | `src/utils/responseParser.ts` | 14-20 | Parses JSON from a string; returns null if parsing fails. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`tryParseJsonFromFence`](../src/utils/responseParser.ts#L23) | function | `src/utils/responseParser.ts` | 23-28 | Extracts and parses JSON from a markdown code fence (``` ```) block. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`tryParseJsonFromObject`](../src/utils/responseParser.ts#L31) | function | `src/utils/responseParser.ts` | 31-36 | Extracts and parses JSON from the first {...} object found in text. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
...
| [`tryParseStructuredRepaired`](../src/utils/responseParser.ts#L103) | function | `src/utils/responseParser.ts` | 103-110 | Repairs literal newlines in text and retries all structured parsing strategies. | `src/commands/summarizeCommands.ts`, `src/services/canvas/clusterBoard.ts`, `src/services/canvas/investigationBoard.ts`, +11 more |
| [`showReviewOrApply`](../src/utils/reviewEditsHelper.ts#L19) | function | `src/utils/reviewEditsHelper.ts` | 19-60 | Shows a review modal (if enabled) comparing old vs. new content, allowing accept/copy/reject actions before applying. | `src/commands/integrationCommands.ts`, `src/commands/smartNoteCommands.ts`, `src/commands/translateCommands.ts`, +1 more |
...
| [`escapeRegex`](../src/utils/sourceDetection.ts#L432) | function | `src/utils/sourceDetection.ts` | 432-434 | Escapes special regex characters in a string to make it safe for use in regular expressions. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`extractFileName`](../src/utils/sourceDetection.ts#L285) | function | `src/utils/sourceDetection.ts` | 285-301 | Extracts and decodes a filename from a URL or file path string. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`extractPdfPath`](../src/utils/sourceDetection.ts#L460) | function | `src/utils/sourceDetection.ts` | 460-471 | Extracts a PDF file path from text, returning wikilink path or URL depending on format. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`extractUrl`](../src/utils/sourceDetection.ts#L445) | function | `src/utils/sourceDetection.ts` | 445-449 | Extracts the first HTTP(S) URL found in text, or returns null if none exists. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
...
| [`hasAnySources`](../src/utils/sourceDetection.ts#L332) | function | `src/utils/sourceDetection.ts` | 332-334 | Returns whether a sources object contains any sources at all. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isAudioUrl`](../src/utils/sourceDetection.ts#L271) | function | `src/utils/sourceDetection.ts` | 271-273 | Returns whether a URL points to an audio file (mp3, wav, m4a, ogg, flac, webm). | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isDocumentUrl`](../src/utils/sourceDetection.ts#L278) | function | `src/utils/sourceDetection.ts` | 278-280 | Returns whether a URL points to an extractable document format. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isPdfLink`](../src/utils/sourceDetection.ts#L452) | function | `src/utils/sourceDetection.ts` | 452-457 | Detects whether text contains a reference to a PDF file (via wikilink or URL). | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isPdfUrl`](../src/utils/sourceDetection.ts#L264) | function | `src/utils/sourceDetection.ts` | 264-266 | Returns whether a URL points to a PDF file. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isUrl`](../src/utils/sourceDetection.ts#L439) | function | `src/utils/sourceDetection.ts` | 439-442 | Detects whether text contains an HTTP or HTTPS URL. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
| [`isYouTubeUrl`](../src/utils/sourceDetection.ts#L257) | function | `src/utils/sourceDetection.ts` | 257-259 | Returns whether a URL is a canonical YouTube link. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
...
| [`truncateUrl`](../src/utils/sourceDetection.ts#L306) | function | `src/utils/sourceDetection.ts` | 306-320 | Shortens a URL to a maximum length by truncating the hostname and pathname with ellipsis. | `src/commands/summarizeCommands.ts`, `src/commands/translateCommands.ts`, `src/commands/webReaderCommands.ts`, +3 more |
...
| [`flushChunk`](../src/utils/textChunker.ts#L195) | function | `src/utils/textChunker.ts` | 195-198 | Trims and adds a non-empty chunk to the chunks array. | `src/services/chat/attachmentIndexService.ts`, `src/services/chunkingOrchestrator.ts`, `src/services/minutes/multiSegmentMinutes.ts`, +4 more |
...
| [`yieldToUi`](../src/utils/textChunker.ts#L36) | function | `src/utils/textChunker.ts` | 36-38 | Yields control back to the UI event loop by deferring execution with a zero timeout. | `src/services/chat/attachmentIndexService.ts`, `src/services/chunkingOrchestrator.ts`, `src/services/minutes/multiSegmentMinutes.ts`, +4 more |
...
| [`cosineSimilarity`](../src/services/vector/vectorMath.ts#L6) | function | `src/services/vector/vectorMath.ts` | 6-24 | Computes the cosine similarity between two numerical vectors using dot product and magnitudes. | `src/services/vector/simpleVectorStore.ts`, `src/services/vector/voyVectorStore.ts`, `src/services/visualEmbedding/visualIndexRepository.ts` |
...
| [`ensureVoyWasmReady`](../src/services/vector/voyVectorStore.ts#L24) | function | `src/services/vector/voyVectorStore.ts` | 24-44 | Initializes the Voy WASM module for vector search by instantiating the WebAssembly module and setting up the glue layer. | `src/services/vector/index.ts`, `src/services/vector/vectorStoreService.ts`, `src/services/visualEmbedding/visualIndexRepository.ts` |
| [`SimpleFileChangeTracker`](../src/services/vector/voyVectorStore.ts#L49) | class | `src/services/vector/voyVectorStore.ts` | 49-72 | <no body> | `src/services/vector/index.ts`, `src/services/vector/vectorStoreService.ts`, `src/services/visualEmbedding/visualIndexRepository.ts` |
