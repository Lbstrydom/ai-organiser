...
describe('GTD Rendering in renderMinutesFromJson', () => {
    ...
    it('should render GTD regardless of style', () => {
        const gtdData = {
            gtd_processing: {
        ...
        const smartBrevity = renderMinutesFromJson(makeMinimalJson(gtdData), 'smart-brevity');
        ...
        expect(smartBrevity).toContain('## GTD: Next Actions');
